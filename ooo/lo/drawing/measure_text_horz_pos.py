...
class MeasureTextHorzPos(Enum):
    ...
    def typeName(self) -> str:
        return 'com.sun.star.drawing.MeasureTextHorzPos'

    AUTO = cast("MeasureTextHorzPosProto", 'AUTO')
    """
    the connection point is chosen automatically,
    
    Set this to have the application select the best horizontal position for the text.
    """
    INSIDE = cast("MeasureTextHorzPosProto", 'INSIDE')
    """
    """
    LEFTOUTSIDE = cast("MeasureTextHorzPosProto", 'LEFTOUTSIDE')
    """
    """
    RIGHTOUTSIDE = cast("MeasureTextHorzPosProto", 'RIGHTOUTSIDE')
    """
    """
