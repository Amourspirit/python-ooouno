...
class AffineMatrix2D(object):
    ...
    **since**
    ...
    def __init__(self, *args, **kwargs):
        ...
        Other Arguments:
            First positinal arg can be another ``AffineMatrix2D`` instance,
                if it is the only argument passed to contructor;
                Otherwise, postitional arguments are treated as ``AffineMatrix2D``
        ...
        arg_len = len(args)
        if arg_len == 1:
            if isinstance(args[0], AffineMatrix2D):
                oth = args[0]
