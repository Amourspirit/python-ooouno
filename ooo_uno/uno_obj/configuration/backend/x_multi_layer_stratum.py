...
class XMultiLayerStratum(XInterface_8f010a43):
    ...
    **since**
    ...
    def getLayer(self, aLayerId: str, aTimestamp: str) -> 'XLayer_4cd50fcb':
        ...
        """
    @abstractmethod
    def getLayers(self, aLayerIds: 'typing.List[str]', aTimestamp: str) -> 'typing.List[XLayer_4cd50fcb]':
        """
        ...
        """
    @abstractmethod
    def getMultipleLayers(self, aLayerIds: 'typing.List[str]', aTimestamps: 'typing.List[str]') -> 'typing.List[XLayer_4cd50fcb]':
        """
    ...
    def getUpdateLayerId(self, aComponent: str, aEntity: str) -> str:
        ...
        """
    @abstractmethod
    def listLayerIds(self, aComponent: str, aEntity: str) -> 'typing.List[str]':
        """
