...
class NoMailTransportProviderException(MailException_ba9e0bdd):
    ...
    **since**
    ...
    __ooo_full_ns__: str = 'com.sun.star.mail.NoMailTransportProviderException'
    __ooo_type_name__: str = 'exception'
    __pyunointerface__: str = 'com.sun.star.mail.NoMailTransportProviderException'
    __pyunostruct__: str = 'com.sun.star.mail.NoMailTransportProviderException'
