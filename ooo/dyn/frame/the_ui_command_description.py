...
if not TYPE_CHECKING and _DYNAMIC:
    def _dynamic_singleton() -> None:
        ...
        import uno
        global theUICommandDescription

        def _singleton_init():
            ctx = uno.getComponentContext()
            key = '/singletons/com.sun.star.frame.theUICommandDescription/service'
            ...
            if not hasattr(singleton, '__ooo_ns__'):
                ...
                setattr(singleton, ' __ooo_full_ns__', 'com.sun.star.frame.theUICommandDescription')
