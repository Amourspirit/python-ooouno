    ...
    def _dynamic_struct() -> None:
        ...
        def _struct_init(*args, **kwargs):
            ...
            if arg_len == 1:
                ...
                if isinstance(args[0], UTemplateIdentifier):
                    struct = uno.createUnoStruct(
                        'com.sun.star.configuration.backend.TemplateIdentifier', args[0])
                    _set_attr(struct)
                    return struct

            key_order = ('Name', 'Component')
            struct = uno.createUnoStruct('com.sun.star.configuration.backend.TemplateIdentifier')
