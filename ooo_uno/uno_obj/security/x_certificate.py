...
class XCertificate(XInterface_8f010a43):
    ...
    **since**
    ...
    @abstractmethod
    def findCertificateExtension(self, oid: 'typing.List[int]') -> 'XCertificateExtension_6ead10f8':
        """
    ...
    def Version(self) -> int:
        ...
        """
    @abstractproperty
    def Encoded(self) -> 'typing.List[int]':
        """
        the DER encoded form of the certificate
        """
    @abstractproperty
    def Extensions(self) -> 'typing.List[XCertificateExtension_6ead10f8]':
        """
        all extensions of a certificate.
        """
    @abstractproperty
    def IssuerUniqueID(self) -> 'typing.List[int]':
        """
        the issuer unique ID attribute of the certificate.
        """
    @abstractproperty
    def MD5Thumbprint(self) -> 'typing.List[int]':
        """
        the MD5 thumbprint
        """
    @abstractproperty
    def SHA1Thumbprint(self) -> 'typing.List[int]':
        """
        the SHA-1 thumbprint
        """
    @abstractproperty
    def SerialNumber(self) -> 'typing.List[int]':
        """
        the serial number attribute of the certificate.
        """
    @abstractproperty
    def SubjectPublicKeyValue(self) -> 'typing.List[int]':
        """
        the value of the subject public key
        """
    @abstractproperty
    def SubjectUniqueID(self) -> 'typing.List[int]':
        """
