...
class ConnectionLostException(BackendAccessException_7cb5161f):
    ...
    **since**
    ...
    __ooo_full_ns__: str = 'com.sun.star.configuration.backend.ConnectionLostException'
    __ooo_type_name__: str = 'exception'
    __pyunointerface__: str = 'com.sun.star.configuration.backend.ConnectionLostException'
    __pyunostruct__: str = 'com.sun.star.configuration.backend.ConnectionLostException'

    typeName: str = 'com.sun.star.configuration.backend.ConnectionLostException'
    """Literal Constant ``com.sun.star.configuration.backend.ConnectionLostException``"""
