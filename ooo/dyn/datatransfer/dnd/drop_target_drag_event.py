    ...
    def _dynamic_struct() -> None:
        ...
        def _struct_init(*args, **kwargs):
            ...
            if arg_len == 1:
                ...
                if isinstance(args[0], UDropTargetDragEvent):
                    struct = uno.createUnoStruct(
                        'com.sun.star.datatransfer.dnd.DropTargetDragEvent', args[0])
                    _set_attr(struct)
                    return struct

            key_order = ('Context', 'DropAction', 'LocationX', 'LocationY', 'SourceActions')
            struct = uno.createUnoStruct('com.sun.star.datatransfer.dnd.DropTargetDragEvent')
