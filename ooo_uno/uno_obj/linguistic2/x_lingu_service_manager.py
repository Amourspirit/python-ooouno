...
class XLinguServiceManager(XInterface_8f010a43):
    ...
    def addLinguServiceManagerListener(self, xListener: 'XEventListener_c7230c4a') -> bool:
        ...
        """
    @abstractmethod
    def getAvailableServices(self, aServiceName: str, aLocale: 'Locale_70d308fa') -> 'typing.List[str]':
        """
        """
    @abstractmethod
    def getConfiguredServices(self, aServiceName: str, aLocale: 'Locale_70d308fa') -> 'typing.List[str]':
        """
    ...
    def removeLinguServiceManagerListener(self, xListener: 'XEventListener_c7230c4a') -> bool:
        ...
        """
    @abstractmethod
    def setConfiguredServices(self, aServiceName: str, aLocale: 'Locale_70d308fa', aServiceImplNames: 'typing.List[str]') -> None:
        """
