...
class XHierarchicalStorageAccess2(XHierarchicalStorageAccess_876b1143):
    ...
    @abstractmethod
    def openEncryptedStreamByHierarchicalName(self, sStreamName: str, nOpenMode: int, aEncryptionData: 'typing.List[NamedValue_a37a0af3]') -> 'XExtendedStorageStream_46750fcf':
        """
