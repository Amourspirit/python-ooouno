...
class XDispatchRecorder(XInterface_8f010a43):
    ...
    **since**
    ...
    def getRecordedMacro(self) -> str:
        ...
        """
    @abstractmethod
    def recordDispatch(self, URL: 'URL_57ad07b9', Arguments: 'typing.List[PropertyValue_c9610c73]') -> None:
        """
        records a single dispatch call identified by its command URL
        """
    @abstractmethod
    def recordDispatchAsComment(self, URL: 'URL_57ad07b9', Arguments: 'typing.List[PropertyValue_c9610c73]') -> None:
        """
