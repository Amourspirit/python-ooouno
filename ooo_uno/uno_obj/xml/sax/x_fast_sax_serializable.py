...
class XFastSAXSerializable(ABC):
    ...
    **since**
    ...
    @abstractmethod
    def fastSerialize(self, handler: 'XFastDocumentHandler_454c0fb6', tokenHandler: 'XFastTokenHandler_17510e78', namespaces: 'typing.List[StringPair_a4bc0b14]', registerNamespaces: 'typing.List[typing.Tuple[str, int]]') -> None:
        """
