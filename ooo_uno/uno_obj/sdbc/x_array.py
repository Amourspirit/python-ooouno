...
class XArray(XInterface_8f010a43):
    ...
    @abstractmethod
    def getArray(self, typeMap: 'XNameAccess_e2ab0cf6') -> 'typing.List[object]':
        """
        ...
        """
    @abstractmethod
    def getArrayAtIndex(self, index: int, count: int, typeMap: 'XNameAccess_e2ab0cf6') -> 'typing.List[object]':
        """
