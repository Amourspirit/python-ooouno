...
class XHalfFloatBitmap(XHalfFloatReadOnlyBitmap_ad83120a):
    ...
    @abstractmethod
    def setData(self, data: 'typing.List[int]', bitmapLayout: 'FloatingPointBitmapLayout_c66812df', rect: 'IntegerRectangle2D_3c5c0f4d') -> None:
        """
        ...
        """
    @abstractmethod
    def setPixel(self, color: 'typing.List[int]', bitmapLayout: 'FloatingPointBitmapLayout_c66812df', pos: 'IntegerPoint2D_8f0dc2') -> None:
        """
