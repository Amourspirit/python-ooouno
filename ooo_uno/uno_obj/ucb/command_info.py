...
if typing.TYPE_CHECKING or _DYNAMIC is False:
    ...
    class CommandInfo(object):
        ...
        Note:
            | At runtime CommandInfo will be an actual uno struct however can seamlessly be treated as a regualr class.
            | At design time a class is presumed. This allows for better typings.
            | CommandInfo is a callable and can be treatead as a class and create instances.
        """

        def __init__(self, ArgType: typing.Optional[object] = None, Handle: typing.Optional[int] = None, Name: typing.Optional[str] = None):
...
if not typing.TYPE_CHECKING and _DYNAMIC:
    def _dynamic_struct() -> None:
        ...
        global CommandInfo
        order = ('ArgType', 'Handle', 'Name')

        def _struct_init(*args, **kwargs):
            struct = uno_helper.create_uno_struct('com.sun.star.ucb.CommandInfo')
