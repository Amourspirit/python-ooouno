...
class MailException(Exception_85530a09):
    ...
    **since**
    ...
    __ooo_full_ns__: str = 'com.sun.star.mail.MailException'
    __ooo_type_name__: str = 'exception'
    __pyunointerface__: str = 'com.sun.star.mail.MailException'
    __pyunostruct__: str = 'com.sun.star.mail.MailException'
