...
if not TYPE_CHECKING and _DYNAMIC:
    ...
    class ProcedureColumn(metaclass=UnoConstMeta, type_name="com.sun.star.sdbc.ProcedureColumn", name_space="com.sun.star.sdbc"):
        """Dynamic Class. Contains all the constant values of ``com.sun.star.sdbc.ProcedureColumn``"""
        pass

    class ProcedureColumnEnum(IntEnum, metaclass=ConstEnumMeta, type_name="com.sun.star.sdbc.ProcedureColumn", name_space="com.sun.star.sdbc"):
        """Dynamic Enum. Contains all the constant values of ``com.sun.star.sdbc.ProcedureColumn`` as Enum values"""
        pass
