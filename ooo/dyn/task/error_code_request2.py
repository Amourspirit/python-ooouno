...
if (not TYPE_CHECKING) and UNO_RUNTIME and UNO_ENVIRONMENT:
    ...
    def _get_class():
        orig_init = None
        ordered_keys = ('Message', 'Context', 'ErrCode', 'Arg1', 'Arg2', 'DialogMask')
        ...
        type_name = 'com.sun.star.task.ErrorCodeRequest2'
    ...
    ErrorCodeRequest2 = _get_class()

else:
    if TYPE_CHECKING:
        from com.sun.star.task import ErrorCodeRequest2 as ErrorCodeRequest2
    else:
