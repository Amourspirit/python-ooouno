...
class BorderLine(object):
    ...
    Note:
        | At runtime BorderLine will be an actual uno struct however can seamlessly be treated as a regualr class.
        | At design time a class is presumed. This allows for better typings.
        | BorderLine is a callable and can be treatead as a class and create instances.
    """

    def __init__(self, Color: 'typing.Optional[Color_68e908c5]' = None, InnerLineWidth: typing.Optional[int] = None, LineDistance: typing.Optional[int] = None, OuterLineWidth: typing.Optional[int] = None):
        self._color = Color
...
def _dynamic_struct() -> None:
    ...
    if ignore == 'True':
        return
    if (not typing.TYPE_CHECKING) and UNO_ENVIRONMENT:
        order = ('Color', 'InnerLineWidth', 'LineDistance', 'OuterLineWidth')
        def _struct_init(*args, **kwargs):
            struct = uno_helper.create_uno_struct('com.sun.star.table.BorderLine')
