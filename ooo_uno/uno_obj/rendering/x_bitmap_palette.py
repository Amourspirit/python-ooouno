...
class XBitmapPalette(XInterface_8f010a43):
    ...
    **since**
    ...
    def getColorSpace(self) -> 'XColorSpace_e3940d09':
        ...
        """
    @abstractmethod
    def getIndex(self, entry: 'typing.List[ColorComponent_e4c0e78]', nIndex: int) -> bool:
        """
    ...
    def getNumberOfEntries(self) -> int:
        ...
        """
    @abstractmethod
    def setIndex(self, color: 'typing.List[ColorComponent_e4c0e78]', transparency: bool, nIndex: int) -> bool:
        """
