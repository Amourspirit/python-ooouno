...
class XSingleSelectQueryComposer(XSingleSelectQueryAnalyzer_66ad10b7):
    ...
    def setOrder(self, order: str) -> None:
        ...
        """
    @abstractmethod
    def setStructuredFilter(self, filter: 'typing.List[typing.List[PropertyValue_c9610c73]]') -> None:
        """
        ...
        """
    @abstractmethod
    def setStructuredHavingClause(self, filter: 'typing.List[typing.List[PropertyValue_c9610c73]]') -> None:
        """
