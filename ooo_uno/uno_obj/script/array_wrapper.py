...
if typing.TYPE_CHECKING or _DYNAMIC is False:
    ...
    class ArrayWrapper(object):
        ...
        Note:
            | At runtime ArrayWrapper will be an actual uno struct however can seamlessly be treated as a regualr class.
            | At design time a class is presumed. This allows for better typings.
            | ArrayWrapper is a callable and can be treatead as a class and create instances.
        """

        def __init__(self, Array: typing.Optional[object] = None, IsZeroIndex: typing.Optional[bool] = None):
            self._array = Array
...
if not typing.TYPE_CHECKING and _DYNAMIC:
    def _dynamic_struct() -> None:
        ...
        global ArrayWrapper
        order = ('Array', 'IsZeroIndex')

        def _struct_init(*args, **kwargs):
            struct = uno_helper.create_uno_struct('com.sun.star.script.ArrayWrapper')
