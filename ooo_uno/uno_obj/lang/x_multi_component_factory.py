...
class XMultiComponentFactory(XInterface_8f010a43):
    ...
    @abstractmethod
    def createInstanceWithArgumentsAndContext(self, ServiceSpecifier: str, Arguments: 'typing.List[object]', Context: 'XComponentContext_e2e10d4a') -> 'XInterface_8f010a43':
        """
