...
if not TYPE_CHECKING and _DYNAMIC:
    def _dynamic_struct():
        ...
        # Dynamically create uno com.sun.star.beans.NamedValue using uno
        global NamedValue

        def _set_fn_attr(struct):
            type_name = 'com.sun.star.beans.NamedValue'
        ...
        def _struct_init(Name = UNO_NONE, Value = UNO_NONE):
            ns = 'com.sun.star.beans.NamedValue'
            if isinstance(Name, UNamedValue):
