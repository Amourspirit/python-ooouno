...
class XIntegerReadOnlyBitmap(XBitmap_b1b70b7b):
    ...
    @abstractmethod
    def getData(self, bitmapLayout: 'IntegerBitmapLayout_5b94106f', rect: 'IntegerRectangle2D_3c5c0f4d') -> 'typing.List[int]':
        """
    ...
    def getMemoryLayout(self) -> 'IntegerBitmapLayout_5b94106f':
        ...
        """
    @abstractmethod
    def getPixel(self, bitmapLayout: 'IntegerBitmapLayout_5b94106f', pos: 'IntegerPoint2D_8f0dc2') -> 'typing.List[int]':
        """
