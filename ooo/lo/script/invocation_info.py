...
class InvocationInfo(object):
    ...
    def __init__(self, aName: typing.Optional[str] = '', eMemberType: typing.Optional[MemberType_b1e00b97] = MemberType_b1e00b97.METHOD, PropertyAttribute: typing.Optional[int] = 0, aType: typing.Optional[object] = None, aParamTypes: typing.Optional[typing.Tuple[object, ...]] = (), aParamModes: typing.Optional[typing.Tuple[ParamMode_d7260ca9, ...]] = ()) -> None:
        """
        Constructor
        ...
        if isinstance(aName, InvocationInfo):
            oth: InvocationInfo = aName
