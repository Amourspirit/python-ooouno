...
class TableFilterField2(object):
    ...
    **since**
    ...
    def __init__(self, *args, **kwargs):
        ...
        Other Arguments:
            First positinal arg can be another ``TableFilterField2`` instance,
                if it is the only argument passed to contructor;
                Otherwise, postitional arguments are treated as ``TableFilterField2``
        ...
        arg_len = len(args)
        if arg_len == 1:
            if isinstance(args[0], TableFilterField2):
                oth = args[0]
