...
class DictionaryEvent(EventObject_a3d70b03):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Other Arguments:
            First positinal arg can be another ``DictionaryEvent`` instance,
                if it is the only argument passed to contructor;
                Otherwise, postitional arguments are treated as ``DictionaryEvent``
        ...
        """
        self._n_event = None
        self._x_dictionary_entry = None

        key_order = ('nEvent', 'xDictionaryEntry')
        arg_len = len(args)
        if arg_len == 1:
            if isinstance(args[0], DictionaryEvent):
                oth = args[0]
