...
class XDataPilotResults(XInterface_8f010a43):
    ...
    @abstractmethod
    def getFilteredResults(self, aFilters: 'typing.List[DataPilotFieldFilter_271e0eed]') -> 'typing.List[float]':
        """
        """
    @abstractmethod
    def getResults(self) -> 'typing.List[typing.List[DataResult_a47d0b1a]]':
        """
