    ...
    **since**
    ...
    def createComponent(self, ObjectType: int, DocumentDefinition: 'XComponent_98dc0ab5') -> 'XComponent_98dc0ab5':
        ...
        * ``DocumentDefinition`` is an out direction argument.
        ...
        """
    @abstractmethod
    def createComponentWithArguments(self, ObjectType: int, Arguments: 'typing.List[PropertyValue_c9610c73]', DocumentDefinition: 'XComponent_98dc0ab5') -> 'XComponent_98dc0ab5':
        """
        creates a new sub component of the given type
    ...
    def loadComponent(self, ObjectType: int, ObjectName: str, ForEditing: bool) -> 'XComponent_98dc0ab5':
        ...
        """
    @abstractmethod
    def loadComponentWithArguments(self, ObjectType: int, ObjectName: str, ForEditing: bool, Arguments: 'typing.List[PropertyValue_c9610c73]') -> 'XComponent_98dc0ab5':
        """
        loads the given sub component of the database document
    ...
    def DataSource(self) -> 'XDataSource_a2990ae7':
        ...
        """
    @abstractproperty
    def SubComponents(self) -> 'typing.List[XComponent_98dc0ab5]':
        """
