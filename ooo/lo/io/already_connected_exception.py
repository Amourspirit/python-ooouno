...
class AlreadyConnectedException(IOException_8c450a27):
    ...
    __ooo_full_ns__: str = 'com.sun.star.io.AlreadyConnectedException'
    __ooo_type_name__: str = 'exception'
    __pyunointerface__: str = 'com.sun.star.io.AlreadyConnectedException'
    __pyunostruct__: str = 'com.sun.star.io.AlreadyConnectedException'
