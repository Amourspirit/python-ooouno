    ...
    def _dynamic_struct() -> None:
        ...
        def _struct_init(*args, **kwargs):
            ...
            if arg_len == 1:
                ...
                if isinstance(args[0], UDataPilotTablePositionData):
                    struct = uno.createUnoStruct(
                        'com.sun.star.sheet.DataPilotTablePositionData', args[0])
                    _set_attr(struct)
                    return struct

            key_order = ('PositionType', 'PositionData')
            struct = uno.createUnoStruct('com.sun.star.sheet.DataPilotTablePositionData')
