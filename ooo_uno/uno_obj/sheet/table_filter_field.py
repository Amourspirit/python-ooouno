...
if typing.TYPE_CHECKING or _DYNAMIC is False:
    ...
    class TableFilterField(object):
        ...
        Note:
            | At runtime TableFilterField will be an actual uno struct however can seamlessly be treated as a regualr class.
            | At design time a class is presumed. This allows for better typings.
            | TableFilterField is a callable and can be treatead as a class and create instances.
        """

        def __init__(self, Connection: 'typing.Optional[FilterConnection_f01f0d97]' = None, Field: typing.Optional[int] = None, IsNumeric: typing.Optional[bool] = None, NumericValue: typing.Optional[float] = None, Operator: 'typing.Optional[FilterOperator_d5c60cd3]' = None, StringValue: typing.Optional[str] = None):
...
if not typing.TYPE_CHECKING and _DYNAMIC:
    def _dynamic_struct() -> None:
        ...
        def _struct_init(*args, **kwargs):
            struct = uno_helper.create_uno_struct('com.sun.star.sheet.TableFilterField')
