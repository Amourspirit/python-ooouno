...
class XRenderable(XInterface_8f010a43):
    ...
    **since**
    ...
    @abstractmethod
    def getRenderer(self, nRenderer: int, aSelection: object, xOptions: 'typing.List[PropertyValue_c9610c73]') -> 'typing.List[PropertyValue_c9610c73]':
        """
        ...
        """
    @abstractmethod
    def getRendererCount(self, aSelection: object, xOptions: 'typing.List[PropertyValue_c9610c73]') -> int:
        """
        ...
        """
    @abstractmethod
    def render(self, nRenderer: int, aSelection: object, xOptions: 'typing.List[PropertyValue_c9610c73]') -> None:
        """
        renders the object.
