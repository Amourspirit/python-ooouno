...
class InvalidTypeNameException(Exception_85530a09):
    ...
    **since**
    ...
    __ooo_full_ns__: str = 'com.sun.star.reflection.InvalidTypeNameException'
    __ooo_type_name__: str = 'exception'
    __pyunointerface__: str = 'com.sun.star.reflection.InvalidTypeNameException'
    __pyunostruct__: str = 'com.sun.star.reflection.InvalidTypeNameException'

    typeName: str = 'com.sun.star.reflection.InvalidTypeNameException'
    """Literal Constant ``com.sun.star.reflection.InvalidTypeNameException``"""
