    ...
    def _dynamic_struct() -> None:
        ...
        def _struct_init(*args, **kwargs):
            ...
            if arg_len == 1:
                ...
                if isinstance(args[0], ULeftRightMarginScale):
                    struct = uno.createUnoStruct(
                        'com.sun.star.frame.status.LeftRightMarginScale', args[0])
                    _set_attr(struct)
                    return struct

            key_order = ('TextLeft', 'Left', 'Right', 'FirstLine', 'ScaleLeft', 'ScaleRight', 'ScaleFirstLine', 'AutoFirstLine')
            struct = uno.createUnoStruct('com.sun.star.frame.status.LeftRightMarginScale')
