...
class BasicErrorException(Exception_85530a09):
    ...
    **since**
    ...
    __ooo_full_ns__: str = 'com.sun.star.script.BasicErrorException'
    __ooo_type_name__: str = 'exception'
    __pyunointerface__: str = 'com.sun.star.script.BasicErrorException'
    __pyunostruct__: str = 'com.sun.star.script.BasicErrorException'

    typeName: str = 'com.sun.star.script.BasicErrorException'
    """Literal Constant ``com.sun.star.script.BasicErrorException``"""

    def __init__(self, Message: typing.Optional[str] = '', Context: typing.Optional[XInterface_8f010a43] = None, ErrorCode: typing.Optional[int] = 0, ErrorMessageArgument: typing.Optional[str] = '') -> None:
        """
        Constructor
        ...
        kargs = {
            ...
            "Context": Context,
            "ErrorCode": ErrorCode,
            "ErrorMessageArgument": ErrorMessageArgument,
        }
        self._init(**kargs)

    def _init(self, **kwargs) -> None:
        self._error_code = kwargs["ErrorCode"]
        self._error_message_argument = kwargs["ErrorMessageArgument"]
        inst_keys = ('ErrorCode', 'ErrorMessageArgument')
        kargs = kwargs.copy()
