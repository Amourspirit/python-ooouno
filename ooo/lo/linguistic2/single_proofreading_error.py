...
class SingleProofreadingError(object):
    ...
    **since**
    ...
    def __init__(self, nErrorStart: typing.Optional[int] = 0, nErrorLength: typing.Optional[int] = 0, nErrorType: typing.Optional[int] = 0, aRuleIdentifier: typing.Optional[str] = '', aShortComment: typing.Optional[str] = '', aFullComment: typing.Optional[str] = '', aSuggestions: typing.Optional[typing.Tuple[str, ...]] = (), aProperties: typing.Optional[typing.Tuple[PropertyValue_c9610c73, ...]] = ()) -> None:
        """
        Constructor
        ...
        if isinstance(nErrorStart, SingleProofreadingError):
            oth: SingleProofreadingError = nErrorStart
