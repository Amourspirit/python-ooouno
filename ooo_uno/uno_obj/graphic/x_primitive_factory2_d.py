...
class XPrimitiveFactory2D(XInterface_8f010a43):
    ...
    @abstractmethod
    def createPrimitivesFromXDrawPage(self, xDrawPage: 'XDrawPage_b07a0b57', aParms: 'typing.List[PropertyValue_c9610c73]') -> 'typing.List[XPrimitive2D_d5730c6d]':
        """
        Create primitives from com.sun.star.drawing.XDrawPage.
        """
    @abstractmethod
    def createPrimitivesFromXShape(self, xShape: 'XShape_8fd00a3d', aParms: 'typing.List[PropertyValue_c9610c73]') -> 'typing.List[XPrimitive2D_d5730c6d]':
        """
