...
class XColorSpace(ABC):
    ...
    @abstractmethod
    def convertColorSpace(self, deviceColor: 'typing.List[ColorComponent_e4c0e78]', targetColorSpace: 'XColorSpace') -> 'typing.List[ColorComponent_e4c0e78]':
        """
        ...
        """
    @abstractmethod
    def convertFromARGB(self, rgbColor: 'typing.List[ARGBColor_c6ee0be1]') -> 'typing.List[ColorComponent_e4c0e78]':
        """
        ...
        """
    @abstractmethod
    def convertFromPARGB(self, rgbColor: 'typing.List[ARGBColor_c6ee0be1]') -> 'typing.List[ColorComponent_e4c0e78]':
        """
        ...
        """
    @abstractmethod
    def convertFromRGB(self, rgbColor: 'typing.List[RGBColor_bbdf0ba0]') -> 'typing.List[ColorComponent_e4c0e78]':
        """
        ...
        """
    @abstractmethod
    def convertToARGB(self, deviceColor: 'typing.List[ColorComponent_e4c0e78]') -> 'typing.List[ARGBColor_c6ee0be1]':
        """
        ...
        """
    @abstractmethod
    def convertToPARGB(self, deviceColor: 'typing.List[ColorComponent_e4c0e78]') -> 'typing.List[ARGBColor_c6ee0be1]':
        """
        ...
        """
    @abstractmethod
    def convertToRGB(self, deviceColor: 'typing.List[ColorComponent_e4c0e78]') -> 'typing.List[RGBColor_bbdf0ba0]':
        """
        ...
        """
    @abstractmethod
    def getComponentTags(self) -> 'typing.List[int]':
        """
        ...
        """
    @abstractmethod
    def getProperties(self) -> 'typing.List[PropertyValue_c9610c73]':
        """
