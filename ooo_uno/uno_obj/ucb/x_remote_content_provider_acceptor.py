...
class XRemoteContentProviderAcceptor(XInterface_8f010a43):
    ...
    @abstractmethod
    def addRemoteContentProvider(self, Identifier: str, Factory: 'XMultiServiceFactory_191e0eb6', Templates: 'typing.List[str]', DoneListener: 'XRemoteContentProviderDoneListener_fc7413f8') -> bool:
        """
