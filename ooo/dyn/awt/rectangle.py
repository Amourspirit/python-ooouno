...
if not TYPE_CHECKING and _DYNAMIC:
    def _dynamic_struct():
        ...
        # Dynamically create uno com.sun.star.awt.Rectangle using uno
        global Rectangle

        def _set_fn_attr(struct):
            type_name = 'com.sun.star.awt.Rectangle'
        ...
        def _set_attr(struct):
            ...
            struct.__dict__['__ooo_full_ns__'] = 'com.sun.star.awt.Rectangle'
            struct.__dict__['__ooo_type_name__'] = 'struct'

        def _struct_init(X = UNO_NONE, Y = UNO_NONE, Width = UNO_NONE, Height = UNO_NONE):
            ns = 'com.sun.star.awt.Rectangle'
            if isinstance(X, URectangle):
