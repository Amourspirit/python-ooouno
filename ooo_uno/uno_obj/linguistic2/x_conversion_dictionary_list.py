...
class XConversionDictionaryList(XInterface_8f010a43):
    ...
    **since**
    ...
    def getDictionaryContainer(self) -> 'XNameContainer_cb90e47':
        ...
        """
    @abstractmethod
    def queryConversions(self, aText: str, nStartPos: int, nLength: int, aLocale: 'Locale_70d308fa', nConversionDictionaryType: int, eDirection: 'ConversionDirection_7dfe113c', nTextConversionOptions: int) -> 'typing.List[str]':
        """
