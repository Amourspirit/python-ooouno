...
class XProofreader(XSupportedLocales_5bda1056):
    ...
    **since**
    ...
    @abstractmethod
    def doProofreading(self, aDocumentIdentifier: str, aText: str, aLocale: 'Locale_70d308fa', nStartOfSentencePosition: int, nSuggestedBehindEndOfSentencePosition: int, aProperties: 'typing.List[PropertyValue_c9610c73]') -> 'ProofreadingResult_6cc910d4':
        """
        start checking
