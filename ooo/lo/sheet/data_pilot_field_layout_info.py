...
class DataPilotFieldLayoutInfo(object):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Other Arguments:
            First positinal arg can be another ``DataPilotFieldLayoutInfo`` instance,
                if it is the only argument passed to contructor;
                Otherwise, postitional arguments are treated as ``DataPilotFieldLayoutInfo``
        ...
        self._add_empty_lines = None

        key_order = ('LayoutMode', 'AddEmptyLines')
        arg_len = len(args)
        if arg_len == 1:
            if isinstance(args[0], DataPilotFieldLayoutInfo):
                oth = args[0]
