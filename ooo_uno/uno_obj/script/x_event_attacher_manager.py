...
class XEventAttacherManager(XInterface_8f010a43):
    ...
    def detach(self, nIndex: int, xObject: 'XInterface_8f010a43') -> None:
        ...
        """
    @abstractmethod
    def getScriptEvents(self, Index: int) -> 'typing.List[ScriptEventDescriptor_4cef1033]':
        """
    ...
    def registerScriptEvent(self, nIndex: int, aScriptEvent: 'ScriptEventDescriptor_4cef1033') -> None:
        ...
        """
    @abstractmethod
    def registerScriptEvents(self, nIndex: int, aScriptEvents: 'typing.List[ScriptEventDescriptor_4cef1033]') -> None:
        """
