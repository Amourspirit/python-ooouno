...
class XIntegerBitmap(XIntegerReadOnlyBitmap_8cc01167):
    ...
    **since**
    ...
    @abstractmethod
    def setData(self, data: 'typing.List[int]', bitmapLayout: 'IntegerBitmapLayout_5b94106f', rect: 'IntegerRectangle2D_3c5c0f4d') -> None:
        """
        ...
        """
    @abstractmethod
    def setPixel(self, color: 'typing.List[int]', bitmapLayout: 'IntegerBitmapLayout_5b94106f', pos: 'IntegerPoint2D_8f0dc2') -> None:
        """
