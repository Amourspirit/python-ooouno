...
class InteractiveNetworkConnectException(InteractiveNetworkException_7ca31159):
    ...
    __ooo_full_ns__: str = 'com.sun.star.ucb.InteractiveNetworkConnectException'
    __ooo_type_name__: str = 'exception'
    __pyunointerface__: str = 'com.sun.star.ucb.InteractiveNetworkConnectException'
    __pyunostruct__: str = 'com.sun.star.ucb.InteractiveNetworkConnectException'
