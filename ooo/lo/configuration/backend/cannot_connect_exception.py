...
class CannotConnectException(BackendSetupException_68ae15de):
    ...
    **since**
    ...
    __ooo_full_ns__: str = 'com.sun.star.configuration.backend.CannotConnectException'
    __ooo_type_name__: str = 'exception'
    __pyunointerface__: str = 'com.sun.star.configuration.backend.CannotConnectException'
    __pyunostruct__: str = 'com.sun.star.configuration.backend.CannotConnectException'
