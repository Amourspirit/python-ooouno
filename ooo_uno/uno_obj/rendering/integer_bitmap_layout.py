...
if typing.TYPE_CHECKING or _DYNAMIC is False:
    ...
    class IntegerBitmapLayout(object):
        ...
        **since**
        ...
        Note:
            | At runtime IntegerBitmapLayout will be an actual uno struct however can seamlessly be treated as a regualr class.
            | At design time a class is presumed. This allows for better typings.
            | IntegerBitmapLayout is a callable and can be treatead as a class and create instances.
        """

        def __init__(self, ColorSpace: 'typing.Optional[XIntegerBitmapColorSpace_b1691234]' = None, IsMsbFirst: typing.Optional[bool] = None, Palette: 'typing.Optional[XBitmapPalette_cf20e4a]' = None, PlaneStride: typing.Optional[int] = None, ScanLineBytes: typing.Optional[int] = None, ScanLineStride: typing.Optional[int] = None, ScanLines: typing.Optional[int] = None):
...
if not typing.TYPE_CHECKING and _DYNAMIC:
    def _dynamic_struct() -> None:
        ...
        order = ('ColorSpace', 'IsMsbFirst', 'Palette', 'PlaneStride', 'ScanLineBytes', 'ScanLineStride', 'ScanLines')

        def _struct_init(*args, **kwargs):
            struct = uno_helper.create_uno_struct('com.sun.star.rendering.IntegerBitmapLayout')
