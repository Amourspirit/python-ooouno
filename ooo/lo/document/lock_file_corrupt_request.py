...
class LockFileCorruptRequest(IOException_8c450a27):
    ...
    **since**
    ...
    __ooo_full_ns__: str = 'com.sun.star.document.LockFileCorruptRequest'
    __ooo_type_name__: str = 'exception'
    __pyunointerface__: str = 'com.sun.star.document.LockFileCorruptRequest'
    __pyunostruct__: str = 'com.sun.star.document.LockFileCorruptRequest'
