    ...
    def _dynamic_struct() -> None:
        ...
        def _struct_init(*args, **kwargs):
            ...
            if arg_len == 1:
                ...
                if isinstance(args[0], UAliasProgrammaticPair):
                    struct = uno.createUnoStruct(
                        'com.sun.star.util.AliasProgrammaticPair', args[0])
                    _set_attr(struct)
                    return struct

            key_order = ('Alias', 'ProgrammaticName')
            struct = uno.createUnoStruct('com.sun.star.util.AliasProgrammaticPair')
