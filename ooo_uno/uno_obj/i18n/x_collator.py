...
class XCollator(XInterface_8f010a43):
    ...
    def compareSubstring(self, aStr1: str, nOff1: int, nLen1: int, aStr2: str, nOff2: int, nLen2: int) -> int:
        ...
        """
    @abstractmethod
    def listCollatorAlgorithms(self, aLocale: 'Locale_70d308fa') -> 'typing.List[str]':
        """
        List all collator algorithms for a given locale.
        """
    @abstractmethod
    def listCollatorOptions(self, aAlgorithmName: str) -> 'typing.List[int]':
        """
    ...
    def loadCollatorAlgorithm(self, aAlgorithmName: str, aLocale: 'Locale_70d308fa', nCollatorOptions: int) -> int:
        ...
        """
    @abstractmethod
    def loadCollatorAlgorithmWithEndUserOption(self, aAlgorithmName: str, aLocale: 'Locale_70d308fa', aCollatorOptions: 'typing.List[int]') -> None:
        """
