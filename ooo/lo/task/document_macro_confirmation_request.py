...
class DocumentMacroConfirmationRequest(ClassifiedInteractionRequest_9f72121b):
    ...
    def __init__(self, Message: typing.Optional[str] = '', Context: typing.Optional[XInterface_8f010a43] = None, Classification: typing.Optional[InteractionClassification_6c4d10e7] = InteractionClassification_6c4d10e7.ERROR, DocumentURL: typing.Optional[str] = '', DocumentStorage: typing.Optional[XStorage_8e460a32] = None, DocumentVersion: typing.Optional[str] = '', DocumentSignatureInformation: typing.Optional[typing.Tuple[DocumentSignatureInformation_f36c13f7, ...]] = ()) -> None:
        """
        Constructor
    ...
    def _init(self, **kwargs) -> None:
        ...
        inst_keys = ('DocumentURL', 'DocumentStorage', 'DocumentVersion', 'DocumentSignatureInformation')
        kargs = kwargs.copy()
