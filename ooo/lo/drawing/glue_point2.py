...
class GluePoint2(object):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Other Arguments:
            First positinal arg can be another ``GluePoint2`` instance,
                if it is the only argument passed to contructor;
                Otherwise, postitional arguments are treated as ``GluePoint2``
        ...
        self._position_alignment = None
        self._escape = None
        self._is_user_defined = None

        key_order = ('Position', 'IsRelative', 'PositionAlignment', 'Escape', 'IsUserDefined')
        arg_len = len(args)
        if arg_len == 1:
            if isinstance(args[0], GluePoint2):
                oth = args[0]
        ...
        if  arg_len > len(key_order):
            raise ValueError("GluePoint2.__init__() To many parameters")
