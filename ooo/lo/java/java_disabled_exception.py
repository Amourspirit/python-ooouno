...
class JavaDisabledException(JavaInitializationException_8b6211a3):
    ...
    **since**
    ...
    __ooo_full_ns__: str = 'com.sun.star.java.JavaDisabledException'
    __ooo_type_name__: str = 'exception'
    __pyunointerface__: str = 'com.sun.star.java.JavaDisabledException'
    __pyunostruct__: str = 'com.sun.star.java.JavaDisabledException'
