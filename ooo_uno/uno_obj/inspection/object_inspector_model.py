...
class ObjectInspectorModel(XObjectInspectorModel_9077119b):
    ...
    **since**
    ...
    def createDefault(self) -> None:
        ...
        """
    @abstractmethod
    def createWithHandlerFactories(self, handlerFactories: 'typing.List[object]') -> None:
        """
        ...
        """
    @abstractmethod
    def createWithHandlerFactoriesAndHelpSection(self, handlerFactories: 'typing.List[object]', minHelpTextLines: int, maxHelpTextLines: int) -> None:
        """
