...
class ControlEvent(object):
    ...
    **since**
    ...
    def __init__(self, aURL: typing.Optional[URL_57ad07b9] = UNO_NONE, Event: typing.Optional[str] = '', aInformation: typing.Optional[typing.Tuple[NamedValue_a37a0af3, ...]] = ()) -> None:
        """
        Constructor
        ...
        if isinstance(aURL, ControlEvent):
            oth: ControlEvent = aURL
            self.aURL = oth.aURL
