...
class XStorable(XInterface_8f010a43):
    ...
    def store(self) -> None:
        ...
        """
    @abstractmethod
    def storeAsURL(self, sURL: str, lArguments: 'typing.List[PropertyValue_c9610c73]') -> None:
        """
        ...
        """
    @abstractmethod
    def storeToURL(self, sURL: str, lArguments: 'typing.List[PropertyValue_c9610c73]') -> None:
        """
