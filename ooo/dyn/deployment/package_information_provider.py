...
if not TYPE_CHECKING and _DYNAMIC:
    def _dynamic_singleton() -> None:
        ...
        import uno
        global PackageInformationProvider

        def _singleton_init():
            ctx = uno.getComponentContext()
            key = '/singletons/com.sun.star.deployment.PackageInformationProvider/service'
            ...
            if not hasattr(singleton, '__ooo_ns__'):
                ...
                setattr(singleton, ' __ooo_full_ns__', 'com.sun.star.deployment.PackageInformationProvider')
