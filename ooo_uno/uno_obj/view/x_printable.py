...
class XPrintable(XInterface_8f010a43):
    ...
    @abstractmethod
    def getPrinter(self) -> 'typing.List[PropertyValue_c9610c73]':
        """
        The attributes of the current printer are used for formatting.
        """
    @abstractmethod
    def print(self, xOptions: 'typing.List[PropertyValue_c9610c73]') -> None:
        """
        prints the object.
        ...
        """
    @abstractmethod
    def setPrinter(self, aPrinter: 'typing.List[PropertyValue_c9610c73]') -> None:
        """
