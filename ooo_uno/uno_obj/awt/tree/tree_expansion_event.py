...
if typing.TYPE_CHECKING or _DYNAMIC is False:
    ...
    class TreeExpansionEvent(EventObject_a3d70b03):
        ...
        Note:
            | At runtime TreeExpansionEvent will be an actual uno struct however can seamlessly be treated as a regualr class.
            | At design time a class is presumed. This allows for better typings.
            | TreeExpansionEvent is a callable and can be treatead as a class and create instances.
        """

        def __init__(self, Node: 'typing.Optional[XTreeNode_baaf0ba0]' = None):
            self._node = Node
...
if not typing.TYPE_CHECKING and _DYNAMIC:
    def _dynamic_struct() -> None:
        ...
        def _struct_init(*args, **kwargs):
            struct = uno_helper.create_uno_struct('com.sun.star.awt.tree.TreeExpansionEvent')
