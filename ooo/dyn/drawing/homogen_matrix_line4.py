...
if not TYPE_CHECKING and _DYNAMIC:
    def _dynamic_struct():
        ...
        # Dynamically create uno com.sun.star.drawing.HomogenMatrixLine4 using uno
        global HomogenMatrixLine4

        def _set_fn_attr(struct):
            type_name = 'com.sun.star.drawing.HomogenMatrixLine4'
        ...
        def _struct_init(Column1 = UNO_NONE, Column2 = UNO_NONE, Column3 = UNO_NONE, Column4 = UNO_NONE):
            ns = 'com.sun.star.drawing.HomogenMatrixLine4'
            if isinstance(Column1, UHomogenMatrixLine4):
