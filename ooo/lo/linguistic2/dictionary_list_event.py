...
class DictionaryListEvent(EventObject_a3d70b03):
    ...
    def __init__(self, Source: typing.Optional[XInterface_8f010a43] = None, nCondensedEvent: typing.Optional[int] = 0, aDictionaryEvents: typing.Optional[typing.Tuple[DictionaryEvent_3ae00f8d, ...]] = ()) -> None:
        """
        Constructor
    ...
    def _init(self, **kwargs) -> None:
        ...
        inst_keys = ('nCondensedEvent', 'aDictionaryEvents')
        kargs = kwargs.copy()
