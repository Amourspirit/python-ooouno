...
class XPasswordContainer(XInterface_8f010a43):
    ...
    @abstractmethod
    def add(self, Url: str, UserName: str, Passwords: 'typing.List[str]', Handler: 'XInteractionHandler_bf80e51') -> None:
        """
        Save passwords into the container.
        """
    @abstractmethod
    def addPersistent(self, Url: str, UserName: str, Passwords: 'typing.List[str]', Handler: 'XInteractionHandler_bf80e51') -> None:
        """
    ...
    def findForName(self, Url: str, UserName: str, Handler: 'XInteractionHandler_bf80e51') -> 'UrlRecord_8f510a4d':
        ...
        """
    @abstractmethod
    def getAllPersistent(self, Handler: 'XInteractionHandler_bf80e51') -> 'typing.List[UrlRecord_8f510a4d]':
        """
