...
class XDocumentRecovery(ABC):
    ...
    @abstractmethod
    def recoverFromFile(self, SourceLocation: str, SalvagedFile: str, MediaDescriptor: 'typing.List[PropertyValue_c9610c73]') -> None:
        """
        ...
        """
    @abstractmethod
    def storeToRecoveryFile(self, TargetLocation: str, MediaDescriptor: 'typing.List[PropertyValue_c9610c73]') -> None:
        """
