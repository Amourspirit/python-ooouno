...
class XIntrospectionAccess(XInterface_8f010a43):
    ...
    def getMethod(self, aName: str, nMethodConcepts: int) -> 'XIdlMethod_e3740d05':
        ...
        """
    @abstractmethod
    def getMethods(self, nMethodConcepts: int) -> 'typing.List[XIdlMethod_e3740d05]':
        """
        returns a sequence of methods of the introspected object.
        """
    @abstractmethod
    def getProperties(self, nPropertyConcepts: int) -> 'typing.List[Property_8f4e0a76]':
        """
    ...
    def getSuppliedPropertyConcepts(self) -> int:
        ...
        """
    @abstractmethod
    def getSupportedListeners(self) -> 'typing.List[object]':
        """
