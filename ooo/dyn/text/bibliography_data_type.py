...
if not TYPE_CHECKING and _DYNAMIC:
    from com.sun.star.text import BibliographyDataType as BibliographyDataType
    if hasattr(BibliographyDataType, '_constants') and isinstance(BibliographyDataType._constants, dict):
        BibliographyDataType._constants['__ooo_ns__'] = 'com.sun.star.text'
        BibliographyDataType._constants['__ooo_full_ns__'] = 'com.sun.star.text.BibliographyDataType'
        BibliographyDataType._constants['__ooo_type_name__'] = 'const'
    def build_enum():
        global BibliographyDataTypeEnum
        ls = [f for f in dir(BibliographyDataType) if not callable(getattr(BibliographyDataType, f)) and not f.startswith('__')]
        _dict = {}
        for name in ls:
            _dict[name] = getattr(BibliographyDataType, name)
        BibliographyDataTypeEnum = IntEnum('BibliographyDataTypeEnum', _dict)
    build_enum()
else:
