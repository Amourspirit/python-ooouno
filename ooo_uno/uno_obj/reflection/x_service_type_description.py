...
class XServiceTypeDescription(XTypeDescription_3c210fb1):
    ...
    **since**
    ...
    @abstractmethod
    def getMandatoryInterfaces(self) -> 'typing.List[XInterfaceTypeDescription_d92e1342]':
        """
        Returns the type descriptions of the mandatory interfaces defined for this service.
        """
    @abstractmethod
    def getMandatoryServices(self) -> 'typing.List[XServiceTypeDescription]':
        """
        Returns the type descriptions of the mandatory services defined for this service.
        """
    @abstractmethod
    def getOptionalInterfaces(self) -> 'typing.List[XInterfaceTypeDescription_d92e1342]':
        """
        Returns the type descriptions of the optional interface defined for this service.
        """
    @abstractmethod
    def getOptionalServices(self) -> 'typing.List[XServiceTypeDescription]':
        """
        Returns the type descriptions of the optional services defined for this service.
        """
    @abstractmethod
    def getProperties(self) -> 'typing.List[XPropertyTypeDescription_ca171316]':
        """
