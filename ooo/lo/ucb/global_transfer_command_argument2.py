...
class GlobalTransferCommandArgument2(GlobalTransferCommandArgument_9ae711da):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Other Arguments:
            First positinal arg can be another ``GlobalTransferCommandArgument2`` instance,
                if it is the only argument passed to contructor;
                Otherwise, postitional arguments are treated as ``GlobalTransferCommandArgument2``
        ...
        arg_len = len(args)
        if arg_len == 1:
            if isinstance(args[0], GlobalTransferCommandArgument2):
                oth = args[0]
