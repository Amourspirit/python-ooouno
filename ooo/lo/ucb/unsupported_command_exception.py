...
class UnsupportedCommandException(Exception_85530a09):
    ...
    __ooo_full_ns__: str = 'com.sun.star.ucb.UnsupportedCommandException'
    __ooo_type_name__: str = 'exception'
    __pyunointerface__: str = 'com.sun.star.ucb.UnsupportedCommandException'
    __pyunostruct__: str = 'com.sun.star.ucb.UnsupportedCommandException'

    typeName: str = 'com.sun.star.ucb.UnsupportedCommandException'
    """Literal Constant ``com.sun.star.ucb.UnsupportedCommandException``"""
