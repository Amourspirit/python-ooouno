...
class InvalidValueException(Exception_85530a09):
    ...
    __ooo_full_ns__: str = 'com.sun.star.registry.InvalidValueException'
    __ooo_type_name__: str = 'exception'
    __pyunointerface__: str = 'com.sun.star.registry.InvalidValueException'
    __pyunostruct__: str = 'com.sun.star.registry.InvalidValueException'
