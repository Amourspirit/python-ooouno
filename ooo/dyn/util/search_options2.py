...
if (not TYPE_CHECKING) and UNO_RUNTIME and UNO_ENVIRONMENT:
    ...
    def _get_class():
        orig_init = None
        ordered_keys = ('algorithmType', 'searchFlag', 'searchString', 'replaceString', 'Locale', 'changedChars', 'deletedChars', 'insertedChars', 'transliterateFlags', 'AlgorithmType2', 'WildcardEscapeCharacter')
    ...
    if TYPE_CHECKING:
        from com.sun.star.util import SearchOptions2 as SearchOptions2
    else:
