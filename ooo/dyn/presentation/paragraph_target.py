    ...
    def _dynamic_struct() -> None:
        ...
        def _struct_init(*args, **kwargs):
            ...
            if arg_len == 1:
                ...
                if isinstance(args[0], UParagraphTarget):
                    struct = uno.createUnoStruct(
                        'com.sun.star.presentation.ParagraphTarget', args[0])
                    _set_attr(struct)
                    return struct

            key_order = ('Shape', 'Paragraph')
            struct = uno.createUnoStruct('com.sun.star.presentation.ParagraphTarget')
