...
class XPackageEncryption(XInterface_8f010a43):
    ...
    **since**
    ...
    def checkDataIntegrity(self) -> bool:
        ...
        """
    @abstractmethod
    def createEncryptionData(self, rPassword: str) -> 'typing.List[NamedValue_a37a0af3]':
        """
    ...
    def decrypt(self, rxInputStream: 'XInputStream_98d40ab4', rxOutputStream: 'XOutputStream_a4e00b35') -> bool:
        ...
        * ``rxOutputStream`` is an out direction argument.
        """
    @abstractmethod
    def encrypt(self, rxInputStream: 'XInputStream_98d40ab4') -> 'typing.List[NamedValue_a37a0af3]':
        """
    ...
    def generateEncryptionKey(self, rPassword: str) -> bool:
        ...
        """
    @abstractmethod
    def readEncryptionInfo(self, rStreams: 'typing.List[NamedValue_a37a0af3]') -> bool:
        """
        Read package crypto information.
        """
    @abstractmethod
    def setupEncryption(self, rMediaEncData: 'typing.List[NamedValue_a37a0af3]') -> bool:
        """
