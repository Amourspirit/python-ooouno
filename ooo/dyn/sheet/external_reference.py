...
if (not TYPE_CHECKING) and UNO_RUNTIME and UNO_ENVIRONMENT:
    ...
    def _get_class():
        orig_init = None
        def init(self, Index = UNO_NONE, Reference = UNO_NONE):
            if getattr(Index, "__class__", None) == self.__class__:
                orig_init(self, Index)
                return
            else:
                orig_init(self)
            ...
            if not Reference is UNO_NONE:
                if getattr(self, 'Reference') != Reference:
                    setattr(self, 'Reference', Reference)

        type_name = 'com.sun.star.sheet.ExternalReference'
