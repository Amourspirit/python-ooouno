...
class XChartDataArray(XChartData_a3580ade):
    ...
    @abstractmethod
    def getColumnDescriptions(self) -> 'typing.List[str]':
        """
    ...
    def getData(self) -> 'typing.List[typing.List[float]]':
        ...
        """
    @abstractmethod
    def getRowDescriptions(self) -> 'typing.List[str]':
        """
        retrieves the description texts for all rows.
        """
    @abstractmethod
    def setColumnDescriptions(self, aColumnDescriptions: 'typing.List[str]') -> None:
        """
        sets the description texts for all columns.
        """
    @abstractmethod
    def setData(self, aData: 'typing.List[typing.List[float]]') -> None:
        """
        sets the chart data as an array of numbers.
        """
    @abstractmethod
    def setRowDescriptions(self, aRowDescriptions: 'typing.List[str]') -> None:
        """
