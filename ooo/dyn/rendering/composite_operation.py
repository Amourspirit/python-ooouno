...
if not TYPE_CHECKING and _DYNAMIC:
    ...
    class CompositeOperation(metaclass=UnoConstMeta, type_name="com.sun.star.rendering.CompositeOperation", name_space="com.sun.star.rendering"):
        """Dynamic Class. Contains all the constant values of ``com.sun.star.rendering.CompositeOperation``"""
        pass

    class CompositeOperationEnum(IntEnum, metaclass=ConstEnumMeta, type_name="com.sun.star.rendering.CompositeOperation", name_space="com.sun.star.rendering"):
        """Dynamic Enum. Contains all the constant values of ``com.sun.star.rendering.CompositeOperation`` as Enum values"""
        pass
