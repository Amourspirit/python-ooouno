...
class XCertificateCreator(XInterface_8f010a43):
    ...
    **since**
    ...
    @abstractmethod
    def addDERCertificateToTheDatabase(self, aDerCertificate: 'typing.List[int]', aTrustString: str) -> 'XCertificate_e55b0d3b':
        """
        Adds a certificate to the certificate database with the trust provided by the trust string.
        """
    @abstractmethod
    def createDERCertificateWithPrivateKey(self, aDerCertificate: 'typing.List[int]', aPrivateKey: 'typing.List[int]') -> 'XCertificate_e55b0d3b':
        """
