...
class XExtendedTextConversion(XTextConversion_cd640c6b):
    ...
    **since**
    ...
    @abstractmethod
    def getConversionWithOffset(self, aText: str, nStartPos: int, nLength: int, aLocale: 'Locale_70d308fa', nTextConversionType: int, nTextConversionOptions: int, rOffset: 'typing.List[int]') -> str:
        """
