...
class XPackage(XComponent_98dc0ab5, XModifyBroadcaster_fd990df0):
    ...
    **since**
    ...
    def exportTo(self, destFolderURL: str, newTitle: str, nameClashAction: int, xCmdEnv: 'XCommandEnvironment_fb330dee') -> None:
        ...
        """
    @abstractmethod
    def getBundle(self, xAbortChannel: 'XAbortChannel_baca0bc4', xCmdEnv: 'XCommandEnvironment_fb330dee') -> 'typing.List[XPackage]':
        """
    ...
    def getURL(self) -> str:
        ...
        """
    @abstractmethod
    def getUpdateInformationURLs(self) -> 'typing.List[str]':
        """
