...
if not TYPE_CHECKING and _DYNAMIC:
    ...
    class CharacterIteratorMode(metaclass=UnoConstMeta, type_name="com.sun.star.i18n.CharacterIteratorMode", name_space="com.sun.star.i18n"):
        """Dynamic Class. Contains all the constant values of ``com.sun.star.i18n.CharacterIteratorMode``"""
        pass

    class CharacterIteratorModeEnum(IntEnum, metaclass=ConstEnumMeta, type_name="com.sun.star.i18n.CharacterIteratorMode", name_space="com.sun.star.i18n"):
        """Dynamic Enum. Contains all the constant values of ``com.sun.star.i18n.CharacterIteratorMode`` as Enum values"""
        pass
