...
class FillBitmap(object):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Other Arguments:
            First positinal arg can be another ``FillBitmap`` instance,
                if it is the only argument passed to contructor;
                Otherwise, postitional arguments are treated as ``FillBitmap``
        ...
        self._a_url = None
        self._a_offset = None
        self._a_position_offset = None
        self._a_rectangle_point = None
        self._b_logical_size = None
        self._a_size = None
        self._a_bitmap_mode = None

        key_order = ('aURL', 'aOffset', 'aPositionOffset', 'aRectanglePoint', 'bLogicalSize', 'aSize', 'aBitmapMode')
        arg_len = len(args)
        if arg_len == 1:
            if isinstance(args[0], FillBitmap):
                oth = args[0]
