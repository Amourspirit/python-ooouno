...
if not TYPE_CHECKING and _DYNAMIC:
    ...
    def _dynamic_exception() -> None:
        ...
        AuthenticationFailedException = unoclass('com.sun.star.auth.AuthenticationFailedException')
        setattr(AuthenticationFailedException, ' __ooo_ns__', 'com.sun.star.auth')
        setattr(AuthenticationFailedException, ' __ooo_full_ns__', 'com.sun.star.auth.AuthenticationFailedException')
