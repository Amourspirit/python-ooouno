...
class XAtomServer(XInterface_8f010a43):
    ...
    def getAtom(self, atomClass: int, description: str, create: bool) -> int:
        ...
        """
    @abstractmethod
    def getAtomDescriptions(self, atoms: 'typing.List[AtomClassRequest_e2a60d36]') -> 'typing.List[str]':
        """
        returns the strings for an arbitrary amount of atoms of multiple classes
        """
    @abstractmethod
    def getClass(self, atomClass: int) -> 'typing.List[AtomDescription_d6080cdb]':
        """
        returns a whole atom class
        """
    @abstractmethod
    def getClasses(self, atomClasses: 'typing.List[int]') -> 'typing.List[typing.List[AtomDescription_d6080cdb]]':
        """
        returns multiple atom classes
        """
    @abstractmethod
    def getRecentAtoms(self, atomClass: int, atom: int) -> 'typing.List[AtomDescription_d6080cdb]':
        """
