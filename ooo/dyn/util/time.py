...
if not TYPE_CHECKING and _DYNAMIC:
    def _dynamic_struct():
        import uno
        from com.sun.star.util import Time as UTime
        # Dynamically create uno com.sun.star.util.Time using uno
        global Time
        ...
        def _set_attr(struct):
            ...
            struct.__dict__['__ooo_full_ns__'] = 'com.sun.star.util.Time'
            struct.__dict__['__ooo_type_name__'] = 'struct'

        def _struct_init(NanoSeconds = UNO_NONE, Seconds = UNO_NONE, Minutes = UNO_NONE, Hours = UNO_NONE, IsUTC = UNO_NONE):
            ns = 'com.sun.star.util.Time'
            if isinstance(NanoSeconds, UTime):
