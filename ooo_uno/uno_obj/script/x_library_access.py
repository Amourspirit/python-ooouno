...
class XLibraryAccess(XInterface_8f010a43):
    ...
    @abstractmethod
    def getFunctionCode(self, FunctionName: str) -> 'typing.List[int]':
        """
    ...
    def getFunctionSource(self, aFunctionName: str) -> str:
        ...
        """
    @abstractmethod
    def getModuleCode(self, aModuleName: str) -> 'typing.List[int]':
        """
        Get the whole compiled code of a module.
        """
    @abstractmethod
    def getModuleNames(self) -> 'typing.List[str]':
        """
