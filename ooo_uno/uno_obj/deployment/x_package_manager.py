...
class XPackageManager(XComponent_98dc0ab5, XModifyBroadcaster_fd990df0):
    ...
    **since**
    ...
    @abstractmethod
    def addPackage(self, url: str, properties: 'typing.List[NamedValue_a37a0af3]', mediaType: str, xAbortChannel: 'XAbortChannel_baca0bc4', xCmdEnv: 'XCommandEnvironment_fb330dee') -> 'XPackage_cb1f0c4d':
        """
        adds a UNO package.
    ...
    def getDeployedPackage(self, identifier: str, fileName: str, xCmdEnv: 'XCommandEnvironment_fb330dee') -> 'XPackage_cb1f0c4d':
        ...
        """
    @abstractmethod
    def getDeployedPackages(self, xAbortChannel: 'XAbortChannel_baca0bc4', xCmdEnv: 'XCommandEnvironment_fb330dee') -> 'typing.List[XPackage_cb1f0c4d]':
        """
        ...
        """
    @abstractmethod
    def getExtensionsWithUnacceptedLicenses(self, xCmdEnv: 'XCommandEnvironment_fb330dee') -> 'typing.List[XPackage_cb1f0c4d]':
        """
