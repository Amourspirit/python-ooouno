...
class XLinkFactory(XInterface_8f010a43):
    ...
    @abstractmethod
    def createInstanceLinkUserInit(self, aClassID: 'typing.List[int]', ClassName: str, xStorage: 'XStorage_8e460a32', sEntryName: str, aArgs: 'typing.List[PropertyValue_c9610c73]', aObjectArgs: 'typing.List[PropertyValue_c9610c73]') -> 'XInterface_8f010a43':
        """
