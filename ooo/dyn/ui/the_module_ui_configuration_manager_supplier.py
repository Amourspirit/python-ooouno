...
if not TYPE_CHECKING and _DYNAMIC:
    def _dynamic_singleton() -> None:
        ...
        import uno
        global theModuleUIConfigurationManagerSupplier

        def _singleton_init():
            ctx = uno.getComponentContext()
            key = '/singletons/com.sun.star.ui.theModuleUIConfigurationManagerSupplier/service'
            ...
            if not hasattr(singleton, '__ooo_ns__'):
                ...
                setattr(singleton, ' __ooo_full_ns__', 'com.sun.star.ui.theModuleUIConfigurationManagerSupplier')
