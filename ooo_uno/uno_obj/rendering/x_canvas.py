...
class XCanvas(XInterface_8f010a43):
    ...
    **since**
    ...
    def clear(self) -> None:
        ...
        """
    @abstractmethod
    def createFont(self, aFontRequest: 'FontRequest_e4890d46', aExtraFontProperties: 'typing.List[PropertyValue_c9610c73]', aFontMatrix: 'Matrix2D_b26c0b5f') -> 'XCanvasFont_e3380d11':
        """
    ...
    def fillPolyPolygon(self, xPolyPolygon: 'XPolyPolygon2D_e1b0e20', aViewState: 'ViewState_cab30c62', aRenderState: 'RenderState_e4490d27') -> 'XCachedPrimitive_29890f0f':
        ...
        """
    @abstractmethod
    def fillTextureMappedPolyPolygon(self, xPolyPolygon: 'XPolyPolygon2D_e1b0e20', aViewState: 'ViewState_cab30c62', aRenderState: 'RenderState_e4490d27', xTextures: 'typing.List[Texture_b2e70bb7]', xMapping: 'XMapping2D_ca1e0c0e') -> 'XCachedPrimitive_29890f0f':
        """
        ...
        """
    @abstractmethod
    def fillTexturedPolyPolygon(self, xPolyPolygon: 'XPolyPolygon2D_e1b0e20', aViewState: 'ViewState_cab30c62', aRenderState: 'RenderState_e4490d27', xTextures: 'typing.List[Texture_b2e70bb7]') -> 'XCachedPrimitive_29890f0f':
        """
    ...
    def getDevice(self) -> 'XGraphicDevice_ca80e2c':
        ...
        """
    @abstractmethod
    def queryAvailableFonts(self, aFilter: 'FontInfo_bded0be9', aFontProperties: 'typing.List[PropertyValue_c9610c73]') -> 'typing.List[FontInfo_bded0be9]':
        """
    ...
    def strokePolyPolygon(self, xPolyPolygon: 'XPolyPolygon2D_e1b0e20', aViewState: 'ViewState_cab30c62', aRenderState: 'RenderState_e4490d27', aStrokeAttributes: 'StrokeAttributes_2dd10f65') -> 'XCachedPrimitive_29890f0f':
        ...
        """
    @abstractmethod
    def strokeTextureMappedPolyPolygon(self, xPolyPolygon: 'XPolyPolygon2D_e1b0e20', aViewState: 'ViewState_cab30c62', aRenderState: 'RenderState_e4490d27', aTextures: 'typing.List[Texture_b2e70bb7]', xMapping: 'XMapping2D_ca1e0c0e', aStrokeAttributes: 'StrokeAttributes_2dd10f65') -> 'XCachedPrimitive_29890f0f':
        """
        ...
        """
    @abstractmethod
    def strokeTexturedPolyPolygon(self, xPolyPolygon: 'XPolyPolygon2D_e1b0e20', aViewState: 'ViewState_cab30c62', aRenderState: 'RenderState_e4490d27', aTextures: 'typing.List[Texture_b2e70bb7]', aStrokeAttributes: 'StrokeAttributes_2dd10f65') -> 'XCachedPrimitive_29890f0f':
        """
