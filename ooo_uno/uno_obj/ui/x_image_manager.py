...
class XImageManager(XComponent_98dc0ab5, XInitialization_d46c0cca, XUIConfiguration_c4eb0c34, XUIConfigurationPersistence_661010b9):
    ...
    @abstractmethod
    def getAllImageNames(self, nImageType: int) -> 'typing.List[str]':
        """
        retrieves the list of command URLs which have images associated.
        """
    @abstractmethod
    def getImages(self, nImageType: int, aCommandURLSequence: 'typing.List[str]') -> 'typing.List[XGraphic_a4da0afc]':
        """
    ...
    def hasImage(self, nImageType: int, CommandURL: str) -> bool:
        ...
        """
    @abstractmethod
    def insertImages(self, nImageType: int, aCommandURLSequence: 'typing.List[str]', aGraphicSequence: 'typing.List[XGraphic_a4da0afc]') -> None:
        """
        ...
        """
    @abstractmethod
    def removeImages(self, nImageType: int, CommandURLs: 'typing.List[str]') -> None:
        """
        ...
        """
    @abstractmethod
    def replaceImages(self, nImageType: int, aCommandURLSequence: 'typing.List[str]', aGraphicsSequence: 'typing.List[XGraphic_a4da0afc]') -> None:
        """
