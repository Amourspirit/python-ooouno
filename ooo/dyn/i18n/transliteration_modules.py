...
if TYPE_CHECKING:
    ...
    class TransliterationModules(uno.Enum):
        ...
        END_OF_MODULE = cast("TransliterationModules", TRANSLITERATION_MODULES_END_OF_MODULE)
        """
        """
        FULLWIDTH_HALFWIDTH = cast("TransliterationModules", TRANSLITERATION_MODULES_FULLWIDTH_HALFWIDTH)
        """
        Transliterate a string from full width character to half width character.
        """
        HALFWIDTH_FULLWIDTH = cast("TransliterationModules", TRANSLITERATION_MODULES_HALFWIDTH_FULLWIDTH)
        """
        Transliterate a string from half width character to full width character.
        """
        HIRAGANA_KATAKANA = cast("TransliterationModules", TRANSLITERATION_MODULES_HIRAGANA_KATAKANA)
        """
        Transliterate a Japanese string from Hiragana to Katakana.
        """
        IGNORE_CASE = cast("TransliterationModules", TRANSLITERATION_MODULES_IGNORE_CASE)
        """
        Ignore case when comparing strings by transliteration service.
        """
        IGNORE_KANA = cast("TransliterationModules", TRANSLITERATION_MODULES_IGNORE_KANA)
        """
        Ignore Hiragana and Katakana when comparing strings by transliteration service.
        """
        IGNORE_MASK = cast("TransliterationModules", TRANSLITERATION_MODULES_IGNORE_MASK)
        """
        """
        IGNORE_WIDTH = cast("TransliterationModules", TRANSLITERATION_MODULES_IGNORE_WIDTH)
        """
        ...
        """
        IgnoreBaFa_ja_JP = cast("TransliterationModules", TRANSLITERATION_MODULES_IgnoreBaFa_ja_JP)
        """
        Ignore Katakana and Hiragana Ba/Gua and Ha/Fa in Japanese fuzzy search.
        """
        IgnoreHyuByu_ja_JP = cast("TransliterationModules", TRANSLITERATION_MODULES_IgnoreHyuByu_ja_JP)
        """
        Ignore Katakana and Hiragana Hyu/Fyu and Byu/Gyu in Japanese fuzzy search.
        """
        IgnoreIandEfollowedByYa_ja_JP = cast("TransliterationModules", TRANSLITERATION_MODULES_IgnoreIandEfollowedByYa_ja_JP)
        """
        ...
        """
        IgnoreIterationMark_ja_JP = cast("TransliterationModules", TRANSLITERATION_MODULES_IgnoreIterationMark_ja_JP)
        """
        Ignore Hiragana and Katakana iteration mark in Japanese fuzzy search.
        """
        IgnoreKiKuFollowedBySa_ja_JP = cast("TransliterationModules", TRANSLITERATION_MODULES_IgnoreKiKuFollowedBySa_ja_JP)
        """
        ...
        """
        IgnoreMiddleDot_ja_JP = cast("TransliterationModules", TRANSLITERATION_MODULES_IgnoreMiddleDot_ja_JP)
        """
        Ignore middle dot in Japanese fuzzy search.
        """
        IgnoreMinusSign_ja_JP = cast("TransliterationModules", TRANSLITERATION_MODULES_IgnoreMinusSign_ja_JP)
        """
        Ignore dash or minus sign in Japanese fuzzy search.
        """
        IgnoreProlongedSoundMark_ja_JP = cast("TransliterationModules", TRANSLITERATION_MODULES_IgnoreProlongedSoundMark_ja_JP)
        """
        Ignore Japanese prolonged sound mark in Japanese fuzzy search.
        """
        IgnoreSeZe_ja_JP = cast("TransliterationModules", TRANSLITERATION_MODULES_IgnoreSeZe_ja_JP)
        """
        Ignore Katakana and Hiragana Se/Sye and Ze/Je in Japanese fuzzy search.
        """
        IgnoreSeparator_ja_JP = cast("TransliterationModules", TRANSLITERATION_MODULES_IgnoreSeparator_ja_JP)
        """
        Ignore separator punctuations in Japanese fuzzy search.
        """
        IgnoreSize_ja_JP = cast("TransliterationModules", TRANSLITERATION_MODULES_IgnoreSize_ja_JP)
        """
        Ignore Japanese normal and small sized character in Japanese fuzzy search.
        """
        IgnoreSpace_ja_JP = cast("TransliterationModules", TRANSLITERATION_MODULES_IgnoreSpace_ja_JP)
        """
        Ignore white space characters, include space, TAB, return, etc. in Japanese fuzzy search.
        """
        IgnoreTiJi_ja_JP = cast("TransliterationModules", TRANSLITERATION_MODULES_IgnoreTiJi_ja_JP)
        """
        Ignore Katakana and Hiragana Tsui/Tea/Ti and Dyi/Ji in Japanese fuzzy search.
        """
        IgnoreTraditionalKana_ja_JP = cast("TransliterationModules", TRANSLITERATION_MODULES_IgnoreTraditionalKana_ja_JP)
        """
        ...
        """
        IgnoreTraditionalKanji_ja_JP = cast("TransliterationModules", TRANSLITERATION_MODULES_IgnoreTraditionalKanji_ja_JP)
        """
        ...
        """
        IgnoreZiZu_ja_JP = cast("TransliterationModules", TRANSLITERATION_MODULES_IgnoreZiZu_ja_JP)
        """
        Ignore Katakana and Hiragana Zi/Zi and Zu/Zu in Japanese fuzzy search.
        """
        KATAKANA_HIRAGANA = cast("TransliterationModules", TRANSLITERATION_MODULES_KATAKANA_HIRAGANA)
        """
        Transliterate a Japanese string from Katakana to Hiragana.
        """
        LOWERCASE_UPPERCASE = cast("TransliterationModules", TRANSLITERATION_MODULES_LOWERCASE_UPPERCASE)
        """
        Transliterate a string from lower case to upper case.
        """
        LargeToSmall_ja_JP = cast("TransliterationModules", TRANSLITERATION_MODULES_LargeToSmall_ja_JP)
        """
        transliterate Japanese normal sized character to small sized character
        """
        NON_IGNORE_MASK = cast("TransliterationModules", TRANSLITERATION_MODULES_NON_IGNORE_MASK)
        """
        """
        NumToTextFormalHangul_ko = cast("TransliterationModules", TRANSLITERATION_MODULES_NumToTextFormalHangul_ko)
        """
        Transliterate an ASCII number string to formal Korean Hangul number string in spellout format.
        """
        NumToTextFormalLower_ko = cast("TransliterationModules", TRANSLITERATION_MODULES_NumToTextFormalLower_ko)
        """
        Transliterate an ASCII number string to formal Korean Hanja lower case number string in spellout format.
        """
        NumToTextFormalUpper_ko = cast("TransliterationModules", TRANSLITERATION_MODULES_NumToTextFormalUpper_ko)
        """
        Transliterate an ASCII number string to formal Korean Hanja upper case number string in spellout format.
        """
        NumToTextLower_zh_CN = cast("TransliterationModules", TRANSLITERATION_MODULES_NumToTextLower_zh_CN)
        """
        Transliterate an ASCII number string to Simplified Chinese lower case number string in spellout format.
        """
        NumToTextLower_zh_TW = cast("TransliterationModules", TRANSLITERATION_MODULES_NumToTextLower_zh_TW)
        """
        Transliterate an ASCII number string to Traditional Chinese lower case number string in spellout format.
        """
        NumToTextUpper_zh_CN = cast("TransliterationModules", TRANSLITERATION_MODULES_NumToTextUpper_zh_CN)
        """
        Transliterate an ASCII number string to Simplified Chinese upper case number string in spellout format.
        """
        NumToTextUpper_zh_TW = cast("TransliterationModules", TRANSLITERATION_MODULES_NumToTextUpper_zh_TW)
        """
        Transliterate an ASCII number string to Traditional Chinese upper case number string in spellout format.
        """
        SmallToLarge_ja_JP = cast("TransliterationModules", TRANSLITERATION_MODULES_SmallToLarge_ja_JP)
        """
        transliterate Japanese small sized character to normal sized character
        """
        UPPERCASE_LOWERCASE = cast("TransliterationModules", TRANSLITERATION_MODULES_UPPERCASE_LOWERCASE)
        """
