...
class XAcceleratorConfiguration(XUIConfiguration_c4eb0c34, XUIConfigurationPersistence_661010b9, XUIConfigurationStorage_25ac0f09):
    ...
    **since**
    ...
    @abstractmethod
    def getAllKeyEvents(self) -> 'typing.List[KeyEvent_7a78097f]':
        """
    ...
    def getCommandByKeyEvent(self, aKeyEvent: 'KeyEvent_7a78097f') -> str:
        ...
        """
    @abstractmethod
    def getKeyEventsByCommand(self, sCommand: str) -> 'typing.List[KeyEvent_7a78097f]':
        """
        ...
        """
    @abstractmethod
    def getPreferredKeyEventsForCommandList(self, lCommandList: 'typing.List[str]') -> 'typing.List[object]':
        """
