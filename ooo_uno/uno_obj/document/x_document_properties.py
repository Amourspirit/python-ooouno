...
class XDocumentProperties(ABC):
    ...
    **since**
    ...
    def getUserDefinedProperties(self) -> 'XPropertyContainer_c600e71':
        ...
        """
    @abstractmethod
    def loadFromMedium(self, URL: str, Medium: 'typing.List[PropertyValue_c9610c73]') -> None:
        """
        ...
        """
    @abstractmethod
    def loadFromStorage(self, Storage: 'XStorage_8e460a32', Medium: 'typing.List[PropertyValue_c9610c73]') -> None:
        """
    ...
    def resetUserData(self, Author: str) -> None:
        ...
        """
    @abstractmethod
    def storeToMedium(self, URL: str, Medium: 'typing.List[PropertyValue_c9610c73]') -> None:
        """
        ...
        """
    @abstractmethod
    def storeToStorage(self, Storage: 'XStorage_8e460a32', Medium: 'typing.List[PropertyValue_c9610c73]') -> None:
        """
    ...
    def Title(self) -> str:
        ...
        """
    @abstractproperty
    def DocumentStatistics(self) -> 'typing.List[NamedValue_a37a0af3]':
        """
