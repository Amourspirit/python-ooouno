...
if not TYPE_CHECKING and _DYNAMIC:
    def _dynamic_ex() -> None:
        import uno
        # Dynamically create uno com.sun.star.task.NoMasterException using uno
        global NoMasterException

        def _set_fn_attr(ex):
            type_name = 'com.sun.star.task.NoMasterException'
        ...
        def _set_attr(ex):
            ...
            ex.__dict__['__ooo_full_ns__'] = 'com.sun.star.task.NoMasterException'
            ex.__dict__['__ooo_type_name__'] = 'exception'

        def _ex_init(Mode = UNO_NONE, **kwargs):
            ns = 'com.sun.star.task.NoMasterException'
