    ...
    def _dynamic_struct() -> None:
        ...
        def _struct_init(*args, **kwargs):
            ...
            if arg_len == 1:
                ...
                if isinstance(args[0], UElementStackItem):
                    struct = uno.createUnoStruct(
                        'com.sun.star.xml.crypto.sax.ElementStackItem', args[0])
                    _set_attr(struct)
                    return struct

            key_order = ('isStartElementEvent', 'elementName', 'xAttributes')
            struct = uno.createUnoStruct('com.sun.star.xml.crypto.sax.ElementStackItem')
