...
class XDispatchInformationProvider(XInterface_8f010a43):
    ...
    **since**
    ...
    @abstractmethod
    def getConfigurableDispatchInformation(self, CommandGroup: int) -> 'typing.List[DispatchInformation_1a290ec9]':
        """
        returns additional information about supported commands of a given command group.
        """
    @abstractmethod
    def getSupportedCommandGroups(self) -> 'typing.List[int]':
        """
