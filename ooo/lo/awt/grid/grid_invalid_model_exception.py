...
class GridInvalidModelException(RuntimeException_d7390ced):
    ...
    **since**
    ...
    __ooo_full_ns__: str = 'com.sun.star.awt.grid.GridInvalidModelException'
    __ooo_type_name__: str = 'exception'
    __pyunointerface__: str = 'com.sun.star.awt.grid.GridInvalidModelException'
    __pyunostruct__: str = 'com.sun.star.awt.grid.GridInvalidModelException'
