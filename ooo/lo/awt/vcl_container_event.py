...
class VclContainerEvent(EventObject_a3d70b03):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Other Arguments:
            First positinal arg can be another ``VclContainerEvent`` instance,
                if it is the only argument passed to contructor;
                Otherwise, postitional arguments are treated as ``VclContainerEvent``
        ...
        arg_len = len(args)
        if arg_len == 1:
            if isinstance(args[0], VclContainerEvent):
                oth = args[0]
