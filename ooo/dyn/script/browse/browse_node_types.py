...
if not TYPE_CHECKING and _DYNAMIC:
    ...
    class BrowseNodeTypes(metaclass=UnoConstMeta, type_name="com.sun.star.script.browse.BrowseNodeTypes", name_space="com.sun.star.script.browse"):
        """Dynamic Class. Contains all the constant values of ``com.sun.star.script.browse.BrowseNodeTypes``"""
        pass

    class BrowseNodeTypesEnum(IntEnum, metaclass=ConstEnumMeta, type_name="com.sun.star.script.browse.BrowseNodeTypes", name_space="com.sun.star.script.browse"):
        """Dynamic Enum. Contains all the constant values of ``com.sun.star.script.browse.BrowseNodeTypes`` as Enum values"""
        pass
