...
class ErrorCodeIOException(IOException_8c450a27):
    ...
    __ooo_full_ns__: str = 'com.sun.star.task.ErrorCodeIOException'
    __ooo_type_name__: str = 'exception'
    __pyunointerface__: str = 'com.sun.star.task.ErrorCodeIOException'
    __pyunostruct__: str = 'com.sun.star.task.ErrorCodeIOException'
