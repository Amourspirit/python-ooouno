...
class XTransliteration(XInterface_8f010a43):
    ...
    def equals(self, aStr1: str, nPos1: int, nCount1: int, rMatch1: int, aStr2: str, nPos2: int, nCount2: int, rMatch2: int) -> bool:
        ...
        * ``rMatch2`` is an out direction argument.
        """
    @abstractmethod
    def folding(self, aInStr: str, nStartPos: int, nCount: int, rOffset: 'typing.List[int]') -> str:
        """

        * ``rOffset`` is an out direction argument.
        """
    @abstractmethod
    def getAvailableModules(self, aLocale: 'Locale_70d308fa', nType: int) -> 'typing.List[str]':
        """
    ...
    def loadModuleByImplName(self, aImplName: str, aLocale: 'Locale_70d308fa') -> None:
        ...
        """
    @abstractmethod
    def loadModuleNew(self, aModType: 'typing.List[TransliterationModulesNew_6260108e]', aLocale: 'Locale_70d308fa') -> None:
        """
        Load a sequence of instances of predefined modules - supersedes method XTransliteration.loadModule().
        """
    @abstractmethod
    def loadModulesByImplNames(self, aImplNameList: 'typing.List[str]', aLocale: 'Locale_70d308fa') -> None:
        """
        ...
        """
    @abstractmethod
    def transliterate(self, aInStr: str, nStartPos: int, nCount: int, rOffset: 'typing.List[int]') -> str:
        """
        ...
        * ``rOffset`` is an out direction argument.
        """
    @abstractmethod
    def transliterateRange(self, aStr1: str, aStr2: str) -> 'typing.List[str]':
        """
