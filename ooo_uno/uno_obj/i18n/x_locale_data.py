...
class XLocaleData(XInterface_8f010a43):
    ...
    @abstractmethod
    def getAllCalendars(self, aLocale: 'Locale_70d308fa') -> 'typing.List[Calendar_7f2d0962]':
        """
        returns all LC_CALENDAR calendars for a locale.
        """
    @abstractmethod
    def getAllCurrencies(self, aLocale: 'Locale_70d308fa') -> 'typing.List[Currency_80230993]':
        """
        returns all LC_CURRENCY currencies for a locale.
        """
    @abstractmethod
    def getAllFormats(self, aLocale: 'Locale_70d308fa') -> 'typing.List[FormatElement_b4c70b7b]':
        """
        returns all LC_FORMAT format elements for a locale.
        """
    @abstractmethod
    def getAllInstalledLocaleNames(self) -> 'typing.List[Locale_70d308fa]':
        """
        returns all available locales.
        """
    @abstractmethod
    def getCollationOptions(self, aLocale: 'Locale_70d308fa') -> 'typing.List[str]':
        """
        returns all LC_COLLATION collation options for a locale.
        """
    @abstractmethod
    def getCollatorImplementations(self, aLocale: 'Locale_70d308fa') -> 'typing.List[Implementation_c1d50c0e]':
        """
    ...
    def getLocaleItem(self, aLocale: 'Locale_70d308fa') -> 'LocaleDataItem_beff0ba1':
        ...
        """
    @abstractmethod
    def getReservedWord(self, aLocale: 'Locale_70d308fa') -> 'typing.List[str]':
        """
        returns all LC_MISC reserved words for a locale.
        """
    @abstractmethod
    def getSearchOptions(self, aLocale: 'Locale_70d308fa') -> 'typing.List[str]':
        """
        returns all LC_SEARCH search options for a locale.
        """
    @abstractmethod
    def getTransliterations(self, aLocale: 'Locale_70d308fa') -> 'typing.List[str]':
        """
