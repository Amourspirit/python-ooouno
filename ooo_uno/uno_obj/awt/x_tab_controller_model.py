...
class XTabControllerModel(XInterface_8f010a43):
    ...
    @abstractmethod
    def getControlModels(self) -> 'typing.List[XControlModel_affc0b7e]':
        """
        returns the control models.
        """
    @abstractmethod
    def getGroup(self, nGroup: int, Group: 'typing.List[XControlModel_affc0b7e]', Name: str) -> None:
        """
        ...
        * ``Name`` is an out direction argument.
        """
    @abstractmethod
    def getGroupByName(self, Name: str, Group: 'typing.List[XControlModel_affc0b7e]') -> None:
        """
    ...
    def getGroupCount(self) -> int:
        ...
        """
    @abstractmethod
    def setControlModels(self, Controls: 'typing.List[XControlModel_affc0b7e]') -> None:
        """
        sets the control models.
        """
    @abstractmethod
    def setGroup(self, Group: 'typing.List[XControlModel_affc0b7e]', GroupName: str) -> None:
        """
