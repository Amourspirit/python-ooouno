...
class XMultiPropertySet(XInterface_8f010a43):
    ...
    @abstractmethod
    def addPropertiesChangeListener(self, aPropertyNames: 'typing.List[str]', xListener: 'XPropertiesChangeListener_7a7d1122') -> None:
        """
        ...
        """
    @abstractmethod
    def firePropertiesChangeEvent(self, aPropertyNames: 'typing.List[str]', xListener: 'XPropertiesChangeListener_7a7d1122') -> None:
        """
    ...
    def getPropertySetInfo(self) -> 'XPropertySetInfo_efa90d86':
        ...
        """
    @abstractmethod
    def getPropertyValues(self, aPropertyNames: 'typing.List[str]') -> 'typing.List[object]':
        """
    ...
    def removePropertiesChangeListener(self, xListener: 'XPropertiesChangeListener_7a7d1122') -> None:
        ...
        """
    @abstractmethod
    def setPropertyValues(self, aPropertyNames: 'typing.List[str]', aValues: 'typing.List[object]') -> None:
        """
