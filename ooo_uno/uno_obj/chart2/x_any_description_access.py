...
class XAnyDescriptionAccess(XComplexDescriptionAccess_7a521120):
    ...
    **since**
    ...
    @abstractmethod
    def getAnyColumnDescriptions(self) -> 'typing.List[typing.List[object]]':
        """
        retrieves the descriptions for all columns.
        """
    @abstractmethod
    def getAnyRowDescriptions(self) -> 'typing.List[typing.List[object]]':
        """
        retrieves the descriptions for all rows.
        """
    @abstractmethod
    def setAnyColumnDescriptions(self, rColumnDescriptions: 'typing.List[typing.List[object]]') -> None:
        """
        sets the descriptions for all columns.
        """
    @abstractmethod
    def setAnyRowDescriptions(self, rRowDescriptions: 'typing.List[typing.List[object]]') -> None:
        """
