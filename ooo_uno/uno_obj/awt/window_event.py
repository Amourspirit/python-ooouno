...
class WindowEvent(EventObject_a3d70b03):
    ...
    Note:
        | At runtime WindowEvent will be an actual uno struct however can seamlessly be treated as a regualr class.
        | At design time a class is presumed. This allows for better typings.
        | WindowEvent is a callable and can be treatead as a class and create instances.
    """

    def __init__(self, BottomInset: typing.Optional[int] = None, Height: typing.Optional[int] = None, LeftInset: typing.Optional[int] = None, RightInset: typing.Optional[int] = None, TopInset: typing.Optional[int] = None, Width: typing.Optional[int] = None, X: typing.Optional[int] = None, Y: typing.Optional[int] = None):
...
def _dynamic_struct() -> None:
    ...
    if ignore == 'True':
        return
    if (not typing.TYPE_CHECKING) and UNO_ENVIRONMENT:
        order = ('BottomInset', 'Height', 'LeftInset', 'RightInset', 'TopInset', 'Width', 'X', 'Y')
        def _struct_init(*args, **kwargs):
            struct = uno_helper.create_uno_struct('com.sun.star.awt.WindowEvent')
