...
class Wizard(XWizard_bae60bc0):
    ...
    **since**
    ...
    @abstractmethod
    def createMultiplePathsWizard(self, PageIds: 'typing.List[typing.List[int]]', Controller: 'XWizardController_469d0fe4') -> None:
        """
        ...
        """
    @abstractmethod
    def createSinglePathWizard(self, PageIds: 'typing.List[int]', Controller: 'XWizardController_469d0fe4') -> None:
        """
