...
class AllEventObject(EventObject_a3d70b03):
    ...
    def __init__(self, Source: typing.Optional[XInterface_8f010a43] = None, Helper: typing.Optional[object] = None, ListenerType: typing.Optional[object] = None, MethodName: typing.Optional[str] = '', Arguments: typing.Optional[typing.Tuple[object, ...]] = ()) -> None:
        """
        Constructor
    ...
    def _init(self, **kwargs) -> None:
        ...
        inst_keys = ('Helper', 'ListenerType', 'MethodName', 'Arguments')
        kargs = kwargs.copy()
