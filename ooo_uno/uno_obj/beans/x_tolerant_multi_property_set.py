...
class XTolerantMultiPropertySet(XInterface_8f010a43):
    ...
    @abstractmethod
    def getDirectPropertyValuesTolerant(self, aPropertyNames: 'typing.List[str]') -> 'typing.List[GetDirectPropertyTolerantResult_e91c13b9]':
        """
        ...
        """
    @abstractmethod
    def getPropertyValuesTolerant(self, aPropertyNames: 'typing.List[str]') -> 'typing.List[GetPropertyTolerantResult_7c4e115e]':
        """
        ...
        """
    @abstractmethod
    def setPropertyValuesTolerant(self, aPropertyNames: 'typing.List[str]', aValues: 'typing.List[object]') -> 'typing.List[SetPropertyTolerantFailed_7cbd1130]':
        """
