...
if typing.TYPE_CHECKING or _DYNAMIC is False:
    ...
    class DatabaseRegistrationEvent(EventObject_a3d70b03):
        ...
        **since**
        ...
        Note:
            | At runtime DatabaseRegistrationEvent will be an actual uno struct however can seamlessly be treated as a regualr class.
            | At design time a class is presumed. This allows for better typings.
            | DatabaseRegistrationEvent is a callable and can be treatead as a class and create instances.
        """

        def __init__(self, Name: typing.Optional[str] = None, NewLocation: typing.Optional[str] = None, OldLocation: typing.Optional[str] = None):
            self._name = Name
...
if not typing.TYPE_CHECKING and _DYNAMIC:
    def _dynamic_struct() -> None:
        ...
        order = ('Name', 'NewLocation', 'OldLocation')

        def _struct_init(*args, **kwargs):
            struct = uno_helper.create_uno_struct('com.sun.star.sdb.DatabaseRegistrationEvent')
