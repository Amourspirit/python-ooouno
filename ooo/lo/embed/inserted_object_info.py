...
class InsertedObjectInfo(object):
    ...
    def __init__(self, Options: typing.Tuple[NamedValue_a37a0af3, ...] = UNO_NONE, Object: XEmbeddedObject_ddee0cbe = None) -> None:
        """
        Constructor

        Other Arguments:
            ``Options`` can be another ``InsertedObjectInfo`` instance,
        ...
        if isinstance(Options, InsertedObjectInfo):
            ...
            self._options = oth.Options
            self._object = oth.Object
            return
        else:
            if Options is UNO_NONE:
                self._options = None
            else:
