...
class XComplexDescriptionAccess(XChartDataArray_df4c0cdd):
    ...
    **since**
    ...
    @abstractmethod
    def getComplexColumnDescriptions(self) -> 'typing.List[typing.List[str]]':
        """
        retrieves the description texts for all columns.
        """
    @abstractmethod
    def getComplexRowDescriptions(self) -> 'typing.List[typing.List[str]]':
        """
        retrieves the description texts for all rows.
        """
    @abstractmethod
    def setComplexColumnDescriptions(self, rColumnDescriptions: 'typing.List[typing.List[str]]') -> None:
        """
        sets the description texts for all columns.
        """
    @abstractmethod
    def setComplexRowDescriptions(self, rRowDescriptions: 'typing.List[typing.List[str]]') -> None:
        """
