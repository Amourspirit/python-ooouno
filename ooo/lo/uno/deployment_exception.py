...
class DeploymentException(RuntimeException_d7390ced):
    ...
    **since**
    ...
    __ooo_full_ns__: str = 'com.sun.star.uno.DeploymentException'
    __ooo_type_name__: str = 'exception'
    __pyunointerface__: str = 'com.sun.star.uno.DeploymentException'
    __pyunostruct__: str = 'com.sun.star.uno.DeploymentException'
