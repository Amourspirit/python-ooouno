...
if (not TYPE_CHECKING) and UNO_RUNTIME and UNO_ENVIRONMENT:
    ...
    if TYPE_CHECKING:
        from com.sun.star.i18n import LocaleDataItem2 as LocaleDataItem2
    else:
