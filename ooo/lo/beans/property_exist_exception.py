...
class PropertyExistException(Exception_85530a09):
    ...
    __ooo_full_ns__: str = 'com.sun.star.beans.PropertyExistException'
    __ooo_type_name__: str = 'exception'
    __pyunointerface__: str = 'com.sun.star.beans.PropertyExistException'
    __pyunostruct__: str = 'com.sun.star.beans.PropertyExistException'
