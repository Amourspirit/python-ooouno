...
class XFormulaParser(ABC):
    ...
    @abstractmethod
    def parseFormula(self, aFormula: str, aReferencePos: 'CellAddress_ae5f0b56') -> 'typing.List[FormulaToken_bd1c0bf8]':
        """
        parses a formula into a sequence of tokens.
        """
    @abstractmethod
    def printFormula(self, aTokens: 'typing.List[FormulaToken_bd1c0bf8]', aReferencePos: 'CellAddress_ae5f0b56') -> str:
        """
