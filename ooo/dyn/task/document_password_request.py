...
if not TYPE_CHECKING and _DYNAMIC:
    def _dynamic_ex() -> None:
        import uno
        # Dynamically create uno com.sun.star.task.DocumentPasswordRequest using uno
        global DocumentPasswordRequest

        def _set_fn_attr(ex):
            type_name = 'com.sun.star.task.DocumentPasswordRequest'
        ...
        def _set_attr(ex):
            ...
            ex.__dict__['__ooo_full_ns__'] = 'com.sun.star.task.DocumentPasswordRequest'
            ex.__dict__['__ooo_type_name__'] = 'exception'

        def _ex_init(**kwargs):
            ns = 'com.sun.star.task.DocumentPasswordRequest'
        ...
        DocumentPasswordRequest = _ex_init
