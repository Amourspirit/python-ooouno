...
class OpenCommandArgument3(OpenCommandArgument2_9210e08):
    ...
    def __init__(self, Mode: typing.Optional[int] = 0, Priority: typing.Optional[int] = 0, Sink: typing.Optional[XInterface_8f010a43] = None, Properties: typing.Optional[typing.Tuple[Property_8f4e0a76, ...]] = (), SortingInfo: typing.Optional[typing.Tuple[NumberedSortingInfo_fd0e0de6, ...]] = (), OpeningFlags: typing.Optional[typing.Tuple[NamedValue_a37a0af3, ...]] = ()) -> None:
        """
        Constructor
        ...
        if isinstance(Mode, OpenCommandArgument3):
            oth: OpenCommandArgument3 = Mode
            self.Mode = oth.Mode
