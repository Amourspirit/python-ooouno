...
class XTextConvert(XInterface_8f010a43):
    ...
    @abstractmethod
    def convertToTable(self, TableRanges: 'typing.List[object]', CellProperties: 'typing.List[typing.List[PropertyValues_d6470ce6]]', RowProperties: 'typing.List[PropertyValues_d6470ce6]', TableProperties: 'PropertyValues_d6470ce6') -> 'XTextTable_9a810ab2':
        """
