...
class XMenuProxyListener(XInterface_8f010a43):
    ...
    @abstractmethod
    def menuChangedMultiple(self, MenuMultipleChanges: 'typing.List[MenuMultipleChange_2cc20f27]') -> None:
        """
        is called, if the content or graphical representation/state of the menu changes completely, for one or more menu items
        """
    @abstractmethod
    def menuChangedSingle(self, MenuSingleChanges: 'typing.List[MenuSingleChange_dad0e3d]') -> None:
        """
