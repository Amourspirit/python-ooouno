    ...
    def _dynamic_struct() -> None:
        ...
        def _struct_init(*args, **kwargs):
            ...
            if arg_len == 1:
                ...
                if isinstance(args[0], UPropertyChangeEvent):
                    struct = uno.createUnoStruct(
                        'com.sun.star.beans.PropertyChangeEvent', args[0])
                    _set_attr(struct)
                    return struct

            key_order = ('PropertyName', 'Further', 'PropertyHandle', 'OldValue', 'NewValue')
            struct = uno.createUnoStruct('com.sun.star.beans.PropertyChangeEvent')
