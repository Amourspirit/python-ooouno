...
if not TYPE_CHECKING and _DYNAMIC:
    ...
    class HatchStyle(metaclass=UnoEnumMeta, type_name="com.sun.star.drawing.HatchStyle", name_space="com.sun.star.drawing"):
        """Dynamically created class that represents ``com.sun.star.drawing.HatchStyle`` Enum. Class loosely mimics Enum"""
        pass
else:
    if TYPE_CHECKING:
