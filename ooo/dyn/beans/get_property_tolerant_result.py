...
if (not TYPE_CHECKING) and UNO_RUNTIME and UNO_ENVIRONMENT:
    ...
    def _get_class():
        orig_init = None
        def init(self, Result = UNO_NONE, State = UNO_NONE, Value = UNO_NONE):
            if getattr(Result, "__class__", None) == self.__class__:
                orig_init(self, Result)
                return
            else:
                orig_init(self)
    ...
    GetPropertyTolerantResult = _get_class()
