...
class XDocumentMetadataAccess(XRepositorySupplier_feff0e30, XURI_5682078c):
    ...
    **since**
    ...
    def addContentOrStylesFile(self, FileName: str) -> None:
        ...
        """
    @abstractmethod
    def addMetadataFile(self, FileName: str, Types: 'typing.List[XURI_5682078c]') -> 'XURI_5682078c':
        """
    ...
    def getElementByURI(self, URI: 'XURI_5682078c') -> 'XMetadatable_a3000af0':
        ...
        """
    @abstractmethod
    def getMetadataGraphsWithType(self, Type: 'XURI_5682078c') -> 'typing.List[XURI_5682078c]':
        """
        ...
        """
    @abstractmethod
    def importMetadataFile(self, Format: int, InStream: 'XInputStream_98d40ab4', FileName: str, BaseURI: 'XURI_5682078c', Types: 'typing.List[XURI_5682078c]') -> 'XURI_5682078c':
        """
        ...
        """
    @abstractmethod
    def loadMetadataFromMedium(self, Medium: 'typing.List[PropertyValue_c9610c73]') -> None:
        """
    ...
    def removeMetadataFile(self, GraphName: 'XURI_5682078c') -> None:
        ...
        """
    @abstractmethod
    def storeMetadataToMedium(self, Medium: 'typing.List[PropertyValue_c9610c73]') -> None:
        """
