...
class XFlatParagraph(XTextMarkup_a5d60b3a):
    ...
    **since**
    ...
    @abstractmethod
    def changeAttributes(self, nPos: int, nLen: int, aAttributes: 'typing.List[PropertyValue_c9610c73]') -> None:
        """
        ...
        """
    @abstractmethod
    def changeText(self, nPos: int, nLen: int, NewText: str, aAttributes: 'typing.List[PropertyValue_c9610c73]') -> None:
        """
    ...
    def getLanguageOfText(self, nPos: int, nLen: int) -> 'Locale_70d308fa':
        ...
        """
    @abstractmethod
    def getLanguagePortions(self) -> 'typing.List[int]':
        """
