...
class StrokeAttributes(object):
    ...
    def __init__(self, StrokeWidth: typing.Optional[float] = 0.0, MiterLimit: typing.Optional[float] = 0.0, DashArray: typing.Optional[typing.Tuple[float, ...]] = (), LineArray: typing.Optional[typing.Tuple[float, ...]] = (), StartCapType: typing.Optional[int] = 0, EndCapType: typing.Optional[int] = 0, JoinType: typing.Optional[int] = 0) -> None:
        """
        Constructor
        ...
        if isinstance(StrokeWidth, StrokeAttributes):
            oth: StrokeAttributes = StrokeWidth
