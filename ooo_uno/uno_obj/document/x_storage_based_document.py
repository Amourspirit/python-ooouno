...
class XStorageBasedDocument(XInterface_8f010a43):
    ...
    def getDocumentStorage(self) -> 'XStorage_8e460a32':
        ...
        """
    @abstractmethod
    def loadFromStorage(self, xStorage: 'XStorage_8e460a32', aMediaDescriptor: 'typing.List[PropertyValue_c9610c73]') -> None:
        """
    ...
    def removeStorageChangeListener(self, xListener: 'XStorageChangeListener_7c7d1120') -> None:
        ...
        """
    @abstractmethod
    def storeToStorage(self, xStorage: 'XStorage_8e460a32', aMediaDescriptor: 'typing.List[PropertyValue_c9610c73]') -> None:
        """
