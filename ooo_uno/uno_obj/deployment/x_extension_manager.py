...
class XExtensionManager(XComponent_98dc0ab5, XModifyBroadcaster_fd990df0):
    ...
    **since**
    ...
    @abstractmethod
    def addExtension(self, url: str, properties: 'typing.List[NamedValue_a37a0af3]', repository: str, xAbortChannel: 'XAbortChannel_baca0bc4', xCmdEnv: 'XCommandEnvironment_fb330dee') -> 'XPackage_cb1f0c4d':
        """
        adds an extension.
    ...
    def enableExtension(self, extension: 'XPackage_cb1f0c4d', xAbortChannel: 'XAbortChannel_baca0bc4', xCmdEnv: 'XCommandEnvironment_fb330dee') -> None:
        ...
        """
    @abstractmethod
    def getAllExtensions(self, xAbortChannel: 'XAbortChannel_baca0bc4', xCmdEnv: 'XCommandEnvironment_fb330dee') -> 'typing.List[typing.List[XPackage_cb1f0c4d]]':
        """
    ...
    def getDeployedExtension(self, repository: str, identifier: str, fileName: str, xCmdEnv: 'XCommandEnvironment_fb330dee') -> 'XPackage_cb1f0c4d':
        ...
        """
    @abstractmethod
    def getDeployedExtensions(self, repository: str, xAbortChannel: 'XAbortChannel_baca0bc4', xCmdEnv: 'XCommandEnvironment_fb330dee') -> 'typing.List[XPackage_cb1f0c4d]':
        """
        ...
        """
    @abstractmethod
    def getExtensionsWithSameIdentifier(self, identifier: str, fileName: str, xCmdEnv: 'XCommandEnvironment_fb330dee') -> 'typing.List[XPackage_cb1f0c4d]':
        """
        ...
        """
    @abstractmethod
    def getExtensionsWithUnacceptedLicenses(self, repository: str, xCmdEnv: 'XCommandEnvironment_fb330dee') -> 'typing.List[XPackage_cb1f0c4d]':
        """
        ...
        """
    @abstractmethod
    def getSupportedPackageTypes(self) -> 'typing.List[XPackageTypeInfo_3bc70f7b]':
        """
