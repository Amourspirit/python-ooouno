...
class XAutomationInvocation(XInvocation_be070c0f):
    ...
    @abstractmethod
    def invokeGetProperty(self, aFunctionName: str, aParams: 'typing.List[object]', aOutParamIndex: 'typing.List[int]', aOutParam: 'typing.List[object]') -> object:
        """
        ...
        * ``aOutParam`` is an out direction argument.
        ...
        """
    @abstractmethod
    def invokePutProperty(self, aFunctionName: str, aParams: 'typing.List[object]', aOutParamIndex: 'typing.List[int]', aOutParam: 'typing.List[object]') -> object:
        """
