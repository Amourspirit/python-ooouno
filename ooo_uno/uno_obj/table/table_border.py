...
class TableBorder(object):
    ...
    Note:
        | At runtime TableBorder will be an actual uno struct however can seamlessly be treated as a regualr class.
        | At design time a class is presumed. This allows for better typings.
        | TableBorder is a callable and can be treatead as a class and create instances.
    """

    def __init__(self, BottomLine: 'typing.Optional[BorderLine_a3f80af6]' = None, Distance: typing.Optional[int] = None, HorizontalLine: 'typing.Optional[BorderLine_a3f80af6]' = None, IsBottomLineValid: typing.Optional[bool] = None, IsDistanceValid: typing.Optional[bool] = None, IsHorizontalLineValid: typing.Optional[bool] = None, IsLeftLineValid: typing.Optional[bool] = None, IsRightLineValid: typing.Optional[bool] = None, IsTopLineValid: typing.Optional[bool] = None, IsVerticalLineValid: typing.Optional[bool] = None, LeftLine: 'typing.Optional[BorderLine_a3f80af6]' = None, RightLine: 'typing.Optional[BorderLine_a3f80af6]' = None, TopLine: 'typing.Optional[BorderLine_a3f80af6]' = None, VerticalLine: 'typing.Optional[BorderLine_a3f80af6]' = None):
...
def _dynamic_struct() -> None:
    ...
    if (not typing.TYPE_CHECKING) and UNO_ENVIRONMENT:
        ...
        def _struct_init(*args, **kwargs):
            struct = uno_helper.create_uno_struct('com.sun.star.table.TableBorder')
