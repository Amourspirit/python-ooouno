...
class LineDescriptor(object):
    ...
    **since**
    ...
    def __init__(self, *args, **kwargs):
        ...
        Other Arguments:
            First positinal arg can be another ``LineDescriptor`` instance,
                if it is the only argument passed to contructor;
                Otherwise, postitional arguments are treated as ``LineDescriptor``
        ...
        self._control = None
        self._help_url = None
        self._has_primary_button = None
        self._primary_button_id = None
        self._primary_button_image_url = None
        self._primary_button_image = None
        self._has_secondary_button = None
        self._secondary_button_id = None
        self._secondary_button_image_url = None
        self._secondary_button_image = None
        ...
        arg_len = len(args)
        if arg_len == 1:
            if isinstance(args[0], LineDescriptor):
                oth = args[0]
