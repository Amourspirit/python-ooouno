...
class InteractiveNetworkOffLineException(InteractiveNetworkException_7ca31159):
    ...
    __ooo_full_ns__: str = 'com.sun.star.ucb.InteractiveNetworkOffLineException'
    __ooo_type_name__: str = 'exception'
    __pyunointerface__: str = 'com.sun.star.ucb.InteractiveNetworkOffLineException'
    __pyunostruct__: str = 'com.sun.star.ucb.InteractiveNetworkOffLineException'

    typeName: str = 'com.sun.star.ucb.InteractiveNetworkOffLineException'
    """Literal Constant ``com.sun.star.ucb.InteractiveNetworkOffLineException``"""
