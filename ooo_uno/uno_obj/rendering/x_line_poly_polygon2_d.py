...
class XLinePolyPolygon2D(XPolyPolygon2D_e1b0e20):
    ...
    **since**
    ...
    def getPoint(self, nPolygonIndex: int, nPointIndex: int) -> 'RealPoint2D_d6e70c78':
        ...
        """
    @abstractmethod
    def getPoints(self, nPolygonIndex: int, nNumberOfPolygons: int, nPointIndex: int, nNumberOfPoints: int) -> 'typing.List[typing.List[RealPoint2D_d6e70c78]]':
        """
    ...
    def setPoint(self, point: 'RealPoint2D_d6e70c78', nPolygonIndex: int, nPointIndex: int) -> None:
        ...
        """
    @abstractmethod
    def setPoints(self, points: 'typing.List[typing.List[RealPoint2D_d6e70c78]]', nPolygonIndex: int) -> None:
        """
