...
class XConversionDictionary(XInterface_8f010a43):
    ...
    **since**
    ...
    def clear(self) -> None:
        ...
        """
    @abstractmethod
    def getConversionEntries(self, eDirection: 'ConversionDirection_7dfe113c') -> 'typing.List[str]':
        """
        """
    @abstractmethod
    def getConversionType(self) -> int:
        ...
        """
    @abstractmethod
    def getConversions(self, aText: str, nStartPos: int, nLength: int, eDirection: 'ConversionDirection_7dfe113c', nTextConversionOptions: int) -> 'typing.List[str]':
        """
