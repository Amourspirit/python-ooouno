...
class XMutableGridDataModel(XGridDataModel_f8b20d71):
    ...
    def addGridDataListener(self, Listener: 'XGridDataListener_23f10ec6') -> None:
        ...
        """
    @abstractmethod
    def addRow(self, Heading: object, Data: 'typing.List[object]') -> None:
        """
        appends a row to the model.
        """
    @abstractmethod
    def addRows(self, Headings: 'typing.List[object]', Data: 'typing.List[typing.List[object]]') -> None:
        """
        ...
        """
    @abstractmethod
    def insertRow(self, Index: int, Heading: object, Data: 'typing.List[object]') -> None:
        """
        ...
        """
    @abstractmethod
    def insertRows(self, Index: int, Headings: 'typing.List[object]', Data: 'typing.List[typing.List[object]]') -> None:
        """
    ...
    def updateCellToolTip(self, ColumnIndex: int, RowIndex: int, Value: object) -> None:
        ...
        """
    @abstractmethod
    def updateRowData(self, ColumnIndexes: 'typing.List[int]', RowIndex: int, Values: 'typing.List[object]') -> None:
        """
