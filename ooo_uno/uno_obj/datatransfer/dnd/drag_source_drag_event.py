...
class DragSourceDragEvent(DragSourceEvent_8ccf115c):
    ...
    Note:
        | At runtime DragSourceDragEvent will be an actual uno struct however can seamlessly be treated as a regualr class.
        | At design time a class is presumed. This allows for better typings.
        | DragSourceDragEvent is a callable and can be treatead as a class and create instances.
    """

    def __init__(self, DropAction: typing.Optional[int] = None, UserAction: typing.Optional[int] = None):
...
def _dynamic_struct() -> None:
    ...
    if ignore == 'True':
        return
    if (not typing.TYPE_CHECKING) and UNO_ENVIRONMENT:
        order = ('DropAction', 'UserAction')
        def _struct_init(*args, **kwargs):
            struct = uno_helper.create_uno_struct('com.sun.star.datatransfer.dnd.DragSourceDragEvent')
