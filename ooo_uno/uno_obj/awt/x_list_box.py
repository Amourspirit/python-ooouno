...
class XListBox(XInterface_8f010a43):
    ...
    def addItemListener(self, l: 'XItemListener_af710b81') -> None:
        ...
        """
    @abstractmethod
    def addItems(self, aItems: 'typing.List[str]', nPos: int) -> None:
        """
    ...
    def getSelectedItems(self) -> 'typing.List[str]':
        ...
        """
    @abstractmethod
    def getSelectedItemsPos(self) -> 'typing.List[int]':
        """
    ...
    def selectItemPos(self, nPos: int, bSelect: bool) -> None:
        ...
        """
    @abstractmethod
    def selectItemsPos(self, aPositions: 'typing.List[int]', bSelect: bool) -> None:
        """
