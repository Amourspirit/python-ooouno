    ...
    def _dynamic_struct() -> None:
        ...
        def _struct_init(*args, **kwargs):
            ...
            if arg_len == 1:
                ...
                if isinstance(args[0], ULineBreakHyphenationOptions):
                    struct = uno.createUnoStruct(
                        'com.sun.star.i18n.LineBreakHyphenationOptions', args[0])
                    _set_attr(struct)
                    return struct

            key_order = ('rHyphenator', 'aHyphenationOptions', 'hyphenIndex')
            struct = uno.createUnoStruct('com.sun.star.i18n.LineBreakHyphenationOptions')
