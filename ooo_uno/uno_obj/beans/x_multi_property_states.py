...
class XMultiPropertyStates(XInterface_8f010a43):
    ...
    @abstractmethod
    def getPropertyDefaults(self, aPropertyNames: 'typing.List[str]') -> 'typing.List[object]':
        """
        ...
        """
    @abstractmethod
    def getPropertyStates(self, aPropertyName: 'typing.List[str]') -> 'typing.List[PropertyState_c97b0c77]':
        """
    ...
    def setAllPropertiesToDefault(self) -> None:
        ...
        """
    @abstractmethod
    def setPropertiesToDefault(self, aPropertyNames: 'typing.List[str]') -> None:
        """
