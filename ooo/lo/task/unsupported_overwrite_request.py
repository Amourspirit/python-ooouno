...
class UnsupportedOverwriteRequest(ClassifiedInteractionRequest_9f72121b):
    ...
    **since**
    ...
    __ooo_full_ns__: str = 'com.sun.star.task.UnsupportedOverwriteRequest'
    __ooo_type_name__: str = 'exception'
    __pyunointerface__: str = 'com.sun.star.task.UnsupportedOverwriteRequest'
    __pyunostruct__: str = 'com.sun.star.task.UnsupportedOverwriteRequest'
