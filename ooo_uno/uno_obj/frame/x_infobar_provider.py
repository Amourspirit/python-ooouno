...
class XInfobarProvider(XInterface_8f010a43):
    ...
    **since**
    ...
    @abstractmethod
    def appendInfobar(self, id: str, primaryMessage: str, secondaryMessage: str, infobarType: int, actionButtons: 'typing.List[StringPair_a4bc0b14]', showCloseButton: bool) -> None:
        """
