...
if (not TYPE_CHECKING) and UNO_RUNTIME and UNO_ENVIRONMENT:
    ...
    def _get_class():
        orig_init = None
        ordered_keys = ('aDocumentIdentifier', 'xFlatParagraph', 'aText', 'aLocale', 'nStartOfSentencePosition', 'nBehindEndOfSentencePosition', 'nStartOfNextSentencePosition', 'aErrors', 'aProperties', 'xProofreader')
    ...
    if TYPE_CHECKING:
        from com.sun.star.linguistic2 import ProofreadingResult as ProofreadingResult
    else:
