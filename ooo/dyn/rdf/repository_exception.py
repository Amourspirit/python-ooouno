...
if (not TYPE_CHECKING) and UNO_RUNTIME and UNO_ENVIRONMENT:
    ...
    def _get_class():
        ...
        type_name = 'com.sun.star.rdf.RepositoryException'
        ex = uno.getClass(type_name)
        ex.__ooo_ns__ = 'com.sun.star.rdf'
    ...
    RepositoryException = _get_class()

else:
    if TYPE_CHECKING:
        from com.sun.star.rdf import RepositoryException as RepositoryException
    else:
