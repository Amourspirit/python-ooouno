...
class XDataInterpreter(XInterface_8f010a43):
    ...
    def getChartTypeSpecificData(self, sKey: str) -> object:
        ...
        """
    @abstractmethod
    def interpretDataSource(self, xSource: 'XDataSource_f6340d57', aArguments: 'typing.List[PropertyValue_c9610c73]', aSeriesToReUse: 'typing.List[XDataSeries_b8150b89]') -> 'InterpretedData_ed4f0d4c':
        """
