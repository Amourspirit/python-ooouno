...
class XRegressionCurveCalculator(XInterface_8f010a43):
    ...
    def getCurveValue(self, x: float) -> float:
        ...
        """
    @abstractmethod
    def getCurveValues(self, min: float, max: float, nPointCount: int, xScalingX: 'XScaling_97500a65', xScalingY: 'XScaling_97500a65', bMaySkipPointsInCalculation: bool) -> 'typing.List[RealPoint2D_d6e70c78]':
        """
    ...
    def getRepresentation(self) -> str:
        ...
        """
    @abstractmethod
    def recalculateRegression(self, aXValues: 'typing.List[float]', aYValues: 'typing.List[float]') -> None:
        """
