...
class DropTargetDragEnterEvent(DropTargetDragEvent_d60612e7):
    ...
    Note:
        | At runtime DropTargetDragEnterEvent will be an actual uno struct however can seamlessly be treated as a regualr class.
        | At design time a class is presumed. This allows for better typings.
        | DropTargetDragEnterEvent is a callable and can be treatead as a class and create instances.
    """

    def __init__(self, SupportedDataFlavors: 'typing.Optional[typing.List[DataFlavor_ffd30deb]]' = None):
        self._supported_data_flavors = SupportedDataFlavors

    @property
    def SupportedDataFlavors(self) -> 'typing.List[DataFlavor_ffd30deb]':
        """
    ...
    def SupportedDataFlavors(self, value: 'typing.List[DataFlavor_ffd30deb]') -> None:
...
def _dynamic_struct() -> None:
    ...
    if ignore == 'True':
        return
    if (not typing.TYPE_CHECKING) and UNO_ENVIRONMENT:
        order = ('SupportedDataFlavors',)
        def _struct_init(*args, **kwargs):
            struct = uno_helper.create_uno_struct('com.sun.star.datatransfer.dnd.DropTargetDragEnterEvent')
