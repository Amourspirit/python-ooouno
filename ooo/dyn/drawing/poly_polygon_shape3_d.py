    ...
    def _dynamic_struct() -> None:
        ...
        def _struct_init(*args, **kwargs):
            ...
            if arg_len == 1:
                ...
                if isinstance(args[0], UPolyPolygonShape3D):
                    struct = uno.createUnoStruct(
                        'com.sun.star.drawing.PolyPolygonShape3D', args[0])
                    _set_attr(struct)
                    return struct

            key_order = ('SequenceX', 'SequenceY', 'SequenceZ')
            struct = uno.createUnoStruct('com.sun.star.drawing.PolyPolygonShape3D')
