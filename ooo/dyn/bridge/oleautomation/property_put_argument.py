...
if not TYPE_CHECKING and _DYNAMIC:
    def _dynamic_struct():
        import uno
        from com.sun.star.bridge.oleautomation import PropertyPutArgument as UPropertyPutArgument
        # Dynamically create uno com.sun.star.bridge.oleautomation.PropertyPutArgument using uno
        global PropertyPutArgument

        def _set_fn_attr(struct):
            type_name = 'com.sun.star.bridge.oleautomation.PropertyPutArgument'
        ...
        def _set_attr(struct):
            ...
            struct.__dict__['__ooo_full_ns__'] = 'com.sun.star.bridge.oleautomation.PropertyPutArgument'
            struct.__dict__['__ooo_type_name__'] = 'struct'

        def _struct_init(Value = UNO_NONE):
            ns = 'com.sun.star.bridge.oleautomation.PropertyPutArgument'
            if isinstance(Value, UPropertyPutArgument):
