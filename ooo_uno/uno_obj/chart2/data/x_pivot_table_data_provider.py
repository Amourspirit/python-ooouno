...
class XPivotTableDataProvider(XInterface_8f010a43):
    ...
    **since**
    ...
    def createDataSequenceOfValuesByIndex(self, nIndex: int) -> 'XDataSequence_11f00e1f':
        ...
        """
    @abstractmethod
    def getColumnFields(self) -> 'typing.List[PivotTableFieldEntry_81a11104]':
        """
        names of column fields from the associated pivot table
        """
    @abstractmethod
    def getDataFields(self) -> 'typing.List[PivotTableFieldEntry_81a11104]':
        """
    ...
    def getFieldOutputDescription(self, nDimensionIndex: int) -> str:
        ...
        """
    @abstractmethod
    def getPageFields(self) -> 'typing.List[PivotTableFieldEntry_81a11104]':
        """
    ...
    def getPivotTableName(self) -> str:
        ...
        """
    @abstractmethod
    def getRowFields(self) -> 'typing.List[PivotTableFieldEntry_81a11104]':
        """
