...
if not TYPE_CHECKING and _DYNAMIC:
    def _dynamic_struct():
        import uno
        from com.sun.star.drawing import Hatch as UHatch
        # Dynamically create uno com.sun.star.drawing.Hatch using uno
        global Hatch
        ...
        def _set_attr(struct):
            ...
            struct.__dict__['__ooo_full_ns__'] = 'com.sun.star.drawing.Hatch'
            struct.__dict__['__ooo_type_name__'] = 'struct'

        def _struct_init(Style = UNO_NONE, Color = UNO_NONE, Distance = UNO_NONE, Angle = UNO_NONE):
            ns = 'com.sun.star.drawing.Hatch'
            if isinstance(Style, UHatch):
