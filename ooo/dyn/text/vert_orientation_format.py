    ...
    def _dynamic_struct() -> None:
        ...
        def _struct_init(*args, **kwargs):
            ...
            if arg_len == 1:
                ...
                if isinstance(args[0], UVertOrientationFormat):
                    struct = uno.createUnoStruct(
                        'com.sun.star.text.VertOrientationFormat', args[0])
                    _set_attr(struct)
                    return struct

            key_order = ('YPos', 'VerticalOrientation', 'VerticalRelation')
            struct = uno.createUnoStruct('com.sun.star.text.VertOrientationFormat')
