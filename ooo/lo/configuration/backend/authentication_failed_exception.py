...
class AuthenticationFailedException(BackendSetupException_68ae15de):
    ...
    **since**
    ...
    __ooo_full_ns__: str = 'com.sun.star.configuration.backend.AuthenticationFailedException'
    __ooo_type_name__: str = 'exception'
    __pyunointerface__: str = 'com.sun.star.configuration.backend.AuthenticationFailedException'
    __pyunostruct__: str = 'com.sun.star.configuration.backend.AuthenticationFailedException'
