...
class XDocumentRevisionListPersistence(XInterface_8f010a43):
    ...
    @abstractmethod
    def load(self, Storage: 'XStorage_8e460a32') -> 'typing.List[RevisionTag_a6770b31]':
        """
        ...
        """
    @abstractmethod
    def store(self, Storage: 'XStorage_8e460a32', List: 'typing.List[RevisionTag_a6770b31]') -> None:
        """
