    ...
    def _dynamic_struct() -> None:
        ...
        def _struct_init(*args, **kwargs):
            ...
            if arg_len == 1:
                ...
                if isinstance(args[0], UDropTargetDragEnterEvent):
                    struct = uno.createUnoStruct(
                        'com.sun.star.datatransfer.dnd.DropTargetDragEnterEvent', args[0])
                    _set_attr(struct)
                    return struct

            key_order = ('SupportedDataFlavors',)
            struct = uno.createUnoStruct('com.sun.star.datatransfer.dnd.DropTargetDragEnterEvent')
