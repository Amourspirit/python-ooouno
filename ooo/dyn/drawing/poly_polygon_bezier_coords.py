    ...
    def _dynamic_struct() -> None:
        ...
        def _struct_init(*args, **kwargs):
            ...
            if arg_len == 1:
                ...
                if isinstance(args[0], UPolyPolygonBezierCoords):
                    struct = uno.createUnoStruct(
                        'com.sun.star.drawing.PolyPolygonBezierCoords', args[0])
                    _set_attr(struct)
                    return struct

            key_order = ('Coordinates', 'Flags')
            struct = uno.createUnoStruct('com.sun.star.drawing.PolyPolygonBezierCoords')
