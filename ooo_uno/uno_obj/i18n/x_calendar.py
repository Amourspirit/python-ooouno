...
class XCalendar(XInterface_8f010a43):
    ...
    **since**
    ...
    def addValue(self, nCalendarFieldIndex: int, nAmount: int) -> None:
        ...
        """
    @abstractmethod
    def getAllCalendars(self, rLocale: 'Locale_70d308fa') -> 'typing.List[str]':
        """
    ...
    def getDateTime(self) -> float:
        ...
        """
    @abstractmethod
    def getDays(self) -> 'typing.List[CalendarItem_a86c0af1]':
        """
    ...
    def getMinimumNumberOfDaysForFirstWeek(self) -> int:
        ...
        """
    @abstractmethod
    def getMonths(self) -> 'typing.List[CalendarItem_a86c0af1]':
        """
