    ...
    def _dynamic_struct() -> None:
        ...
        def _struct_init(*args, **kwargs):
            ...
            if arg_len == 1:
                ...
                if isinstance(args[0], UUpperLowerMargin):
                    struct = uno.createUnoStruct(
                        'com.sun.star.frame.status.UpperLowerMargin', args[0])
                    _set_attr(struct)
                    return struct

            key_order = ('Upper', 'Lower')
            struct = uno.createUnoStruct('com.sun.star.frame.status.UpperLowerMargin')
