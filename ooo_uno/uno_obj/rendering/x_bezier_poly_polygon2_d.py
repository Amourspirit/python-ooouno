...
class XBezierPolyPolygon2D(XPolyPolygon2D_e1b0e20):
    ...
    **since**
    ...
    def getBezierSegment(self, nPolygonIndex: int, nPointIndex: int) -> 'RealBezierSegment2D_4a970fa2':
        ...
        """
    @abstractmethod
    def getBezierSegments(self, nPolygonIndex: int, nNumberOfPolygons: int, nPointIndex: int, nNumberOfPoints: int) -> 'typing.List[typing.List[RealBezierSegment2D_4a970fa2]]':
        """
    ...
    def setBezierSegment(self, point: 'RealBezierSegment2D_4a970fa2', nPolygonIndex: int, nPointIndex: int) -> None:
        ...
        """
    @abstractmethod
    def setBezierSegments(self, points: 'typing.List[typing.List[RealBezierSegment2D_4a970fa2]]', nPolygonIndex: int) -> None:
        """
