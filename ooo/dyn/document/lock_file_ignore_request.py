...
if not TYPE_CHECKING and _DYNAMIC:
    def _dynamic_ex() -> None:
        import uno
        # Dynamically create uno com.sun.star.document.LockFileIgnoreRequest using uno
        global LockFileIgnoreRequest

        def _set_attr(ex):
            ex.__dict__['__ooo_ns__'] = 'com.sun.star.document'
            ex.__dict__['__ooo_full_ns__'] = 'com.sun.star.document.LockFileIgnoreRequest'
            ex.__dict__['__ooo_type_name__'] = 'exception'

        def _ex_init(**kwargs):
            ns = 'com.sun.star.document.LockFileIgnoreRequest'
            ...
            _set_attr(ex)
            return ex
        LockFileIgnoreRequest = _ex_init
