...
if (not TYPE_CHECKING) and UNO_RUNTIME and UNO_ENVIRONMENT:
    ...
    def _get_class():
        orig_init = None
        ordered_keys = ('Message', 'Context', 'Classification', 'Mode', 'Name', 'IsRequestPasswordToModify')
    ...
    DocumentMSPasswordRequest2 = _get_class()

else:
    if TYPE_CHECKING:
        from com.sun.star.task import DocumentMSPasswordRequest2 as DocumentMSPasswordRequest2
    else:
