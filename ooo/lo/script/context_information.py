...
class ContextInformation(object):
    ...
    def __init__(self, Name: typing.Optional[str] = '', SourceCode: typing.Optional[str] = '', StartLine: typing.Optional[int] = 0, StartColumn: typing.Optional[int] = 0, EndLine: typing.Optional[int] = 0, EndColumn: typing.Optional[int] = 0, LocalVariableNames: typing.Optional[typing.Tuple[str, ...]] = ()) -> None:
        """
        Constructor
        ...
        if isinstance(Name, ContextInformation):
            oth: ContextInformation = Name
            self.Name = oth.Name
