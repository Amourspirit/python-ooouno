...
class XEmbedObjectFactory(XInterface_8f010a43):
    ...
    @abstractmethod
    def createInstanceUserInit(self, aClassID: 'typing.List[int]', sClassName: str, xStorage: 'XStorage_8e460a32', sEntName: str, nEntryConnectionMode: int, aArgs: 'typing.List[PropertyValue_c9610c73]', aObjectArgs: 'typing.List[PropertyValue_c9610c73]') -> 'XInterface_8f010a43':
        """
