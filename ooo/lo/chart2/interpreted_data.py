...
class InterpretedData(object):
    ...
    def __init__(self, Series: typing.Optional[typing.Tuple[typing.Tuple[XDataSeries_b8150b89, ...], ...]] = None, Categories: typing.Optional[XLabeledDataSequence_7e1a10c8] = None) -> None:
        """
        Constructor
        ...
        if kargs["Series"] is UNO_NONE:
            kargs["Series"] = None
        if kargs["Categories"] is UNO_NONE:
            kargs["Categories"] = None
        self._init(**kargs)
