...
class XAnimatedImages(XContainer_d6fb0cc6):
    ...
    **since**
    ...
    @abstractmethod
    def getImageSet(self, iIndex: int) -> 'typing.List[str]':
        """
    ...
    def getImageSetCount(self) -> int:
        ...
        """
    @abstractmethod
    def insertImageSet(self, iIndex: int, iImageURLs: 'typing.List[str]') -> None:
        """
    ...
    def removeImageSet(self, iIndex: int) -> None:
        ...
        """
    @abstractmethod
    def replaceImageSet(self, iIndex: int, iImageURLs: 'typing.List[str]') -> None:
        """
