...
if (not TYPE_CHECKING) and UNO_RUNTIME and UNO_ENVIRONMENT:
    ...
    def _get_class():
        orig_init = None
        def init(self, Days = UNO_NONE, Months = UNO_NONE, Eras = UNO_NONE, StartOfWeek = UNO_NONE, MinimumNumberOfDaysForFirstWeek = UNO_NONE, Default = UNO_NONE, Name = UNO_NONE):
