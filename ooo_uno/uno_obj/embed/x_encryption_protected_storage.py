...
class XEncryptionProtectedStorage(XEncryptionProtectedSource2_9eb411d5):
    ...
    **since**
    ...
    @abstractmethod
    def getEncryptionAlgorithms(self) -> 'typing.List[NamedValue_a37a0af3]':
        """
        allows to get the encryption algorithms of the object.
        """
    @abstractmethod
    def setEncryptionAlgorithms(self, aAlgorithms: 'typing.List[NamedValue_a37a0af3]') -> None:
        """
        ...
        """
    @abstractmethod
    def setGpgProperties(self, aProps: 'typing.List[typing.List[NamedValue_a37a0af3]]') -> None:
        """
