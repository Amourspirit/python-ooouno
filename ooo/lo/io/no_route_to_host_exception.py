...
class NoRouteToHostException(SocketException_bb650bf8):
    ...
    __ooo_full_ns__: str = 'com.sun.star.io.NoRouteToHostException'
    __ooo_type_name__: str = 'exception'
    __pyunointerface__: str = 'com.sun.star.io.NoRouteToHostException'
    __pyunostruct__: str = 'com.sun.star.io.NoRouteToHostException'

    typeName: str = 'com.sun.star.io.NoRouteToHostException'
    """Literal Constant ``com.sun.star.io.NoRouteToHostException``"""
