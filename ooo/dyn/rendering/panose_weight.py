...
if not TYPE_CHECKING and _DYNAMIC:
    ...
    class PanoseWeight(metaclass=UnoConstMeta, type_name="com.sun.star.rendering.PanoseWeight", name_space="com.sun.star.rendering"):
        """Dynamic Class. Contains all the constant values of ``com.sun.star.rendering.PanoseWeight``"""
        pass

    class PanoseWeightEnum(IntEnum, metaclass=ConstEnumMeta, type_name="com.sun.star.rendering.PanoseWeight", name_space="com.sun.star.rendering"):
        """Dynamic Enum. Contains all the constant values of ``com.sun.star.rendering.PanoseWeight`` as Enum values"""
        pass
