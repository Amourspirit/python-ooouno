...
class XDocumentRepository(XRepository_995d0adc):
    ...
    **since**
    ...
    def removeStatementRDFa(self, Element: 'XMetadatable_a3000af0') -> None:
        ...
        """
    @abstractmethod
    def setStatementRDFa(self, Subject: 'XResource_842709e4', Predicates: 'typing.List[XURI_5682078c]', Object: 'XMetadatable_a3000af0', RDFaContent: str, RDFaDatatype: 'XURI_5682078c') -> None:
        """
