...
class HomogenMatrixLine4(object):
    ...
    __ooo_full_ns__: str = 'com.sun.star.drawing.HomogenMatrixLine4'
    ...
    def __init__(self, *args, **kwargs):
        ...
        Other Arguments:
            First positinal arg can be another ``HomogenMatrixLine4`` instance,
                if it is the only argument passed to contructor;
                Otherwise, postitional arguments are treated as ``HomogenMatrixLine4``
        ...
        arg_len = len(args)
        if arg_len == 1:
            if isinstance(args[0], HomogenMatrixLine4):
                oth = args[0]
