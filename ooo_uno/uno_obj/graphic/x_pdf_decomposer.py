...
class XPdfDecomposer(XInterface_8f010a43):
    ...
    **since**
    ...
    @abstractmethod
    def getDecomposition(self, xDataContainer: 'XBinaryDataContainer_19270ea0', xDecompositionParameters: 'typing.List[PropertyValue_c9610c73]') -> 'typing.List[XPrimitive2D_d5730c6d]':
        """
