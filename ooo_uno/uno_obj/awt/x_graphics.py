...
class XGraphics(XInterface_8f010a43):
    ...
    def drawPixel(self, X: int, Y: int) -> None:
        ...
        """
    @abstractmethod
    def drawPolyLine(self, DataX: 'typing.List[int]', DataY: 'typing.List[int]') -> None:
        """
        draws multiple lines in the output device at once.
        """
    @abstractmethod
    def drawPolyPolygon(self, DataX: 'typing.List[typing.List[int]]', DataY: 'typing.List[typing.List[int]]') -> None:
        """
        draws multiple polygons in the output device at once.
        """
    @abstractmethod
    def drawPolygon(self, DataX: 'typing.List[int]', DataY: 'typing.List[int]') -> None:
        """
    ...
    def drawText(self, X: int, Y: int, Text: str) -> None:
        ...
        """
    @abstractmethod
    def drawTextArray(self, X: int, Y: int, Text: str, Longs: 'typing.List[int]') -> None:
        """
