...
class IntrospectionException(Exception_85530a09):
    ...
    __ooo_full_ns__: str = 'com.sun.star.beans.IntrospectionException'
    __ooo_type_name__: str = 'exception'
    __pyunointerface__: str = 'com.sun.star.beans.IntrospectionException'
    __pyunostruct__: str = 'com.sun.star.beans.IntrospectionException'
