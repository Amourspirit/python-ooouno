...
class RealBezierSegment2D(object):
    ...
    **since**
    ...
    __ooo_full_ns__: str = 'com.sun.star.geometry.RealBezierSegment2D'
    ...
    def __init__(self, *args, **kwargs):
        ...
        Other Arguments:
            First positinal arg can be another ``RealBezierSegment2D`` instance,
                if it is the only argument passed to contructor;
                Otherwise, postitional arguments are treated as ``RealBezierSegment2D``
        ...
        arg_len = len(args)
        if arg_len == 1:
            if isinstance(args[0], RealBezierSegment2D):
                oth = args[0]
