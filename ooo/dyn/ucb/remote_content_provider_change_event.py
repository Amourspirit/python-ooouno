    ...
    def _dynamic_struct() -> None:
        ...
        def _struct_init(*args, **kwargs):
            ...
            if arg_len == 1:
                ...
                if isinstance(args[0], URemoteContentProviderChangeEvent):
                    struct = uno.createUnoStruct(
                        'com.sun.star.ucb.RemoteContentProviderChangeEvent', args[0])
                    _set_attr(struct)
                    return struct

            key_order = ('Identifier', 'Action')
            struct = uno.createUnoStruct('com.sun.star.ucb.RemoteContentProviderChangeEvent')
