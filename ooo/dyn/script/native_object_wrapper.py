...
if not TYPE_CHECKING and _DYNAMIC:
    def _dynamic_struct():
        ...
        def _struct_init(ObjectId = UNO_NONE):
            ns = 'com.sun.star.script.NativeObjectWrapper'
            if isinstance(ObjectId, UNativeObjectWrapper):
                inst = uno.createUnoStruct(ns, ObjectId)
                _set_attr(inst)
                return inst
            struct = uno.createUnoStruct(ns)

            if not ObjectId is UNO_NONE:
