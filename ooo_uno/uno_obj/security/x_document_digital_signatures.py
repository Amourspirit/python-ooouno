    ...
    **since**
    ...
    def chooseCertificate(self, Description: str) -> 'XCertificate_e55b0d3b':
        ...
        * ``Description`` is an out direction argument.
        """
    @abstractmethod
    def chooseCertificateWithProps(self, Properties: 'typing.List[PropertyValue_c9610c73]') -> 'XCertificate_e55b0d3b':
        """
        ...
        * ``Properties`` is an out direction argument.
        """
    @abstractmethod
    def chooseEncryptionCertificate(self) -> 'typing.List[XCertificate_e55b0d3b]':
        """
    ...
    def signSignatureLine(self, xStorage: 'XStorage_8e460a32', xSignStream: 'XStream_678908a4', signatureLineId: str, xCertificate: 'XCertificate_e55b0d3b', xValidGraphic: 'XGraphic_a4da0afc', xInvalidGraphic: 'XGraphic_a4da0afc', comment: str) -> bool:
        ...
        **since**
        ...
        """
    @abstractmethod
    def verifyDocumentContentSignatures(self, xStorage: 'XStorage_8e460a32', xSignInStream: 'XInputStream_98d40ab4') -> 'typing.List[DocumentSignatureInformation_f36c13f7]':
        """
        ...
        """
    @abstractmethod
    def verifyPackageSignatures(self, Storage: 'XStorage_8e460a32', xSignInStream: 'XInputStream_98d40ab4') -> 'typing.List[DocumentSignatureInformation_f36c13f7]':
        """
        checks for digital signatures and their status.
        ...
        """
    @abstractmethod
    def verifyScriptingContentSignatures(self, xStorage: 'XStorage_8e460a32', xSignInStream: 'XInputStream_98d40ab4') -> 'typing.List[DocumentSignatureInformation_f36c13f7]':
        """
        checks for digital signatures and their status.
