...
if TYPE_CHECKING:
    from com.sun.star.frame.FrameAction import FrameActionProto
...
class FrameAction(Enum):
    ...
    COMPONENT_ATTACHED = cast("FrameActionProto", 'COMPONENT_ATTACHED')
    """
    ...
    """
    COMPONENT_DETACHING = cast("FrameActionProto", 'COMPONENT_DETACHING')
    """
    ...
    """
    COMPONENT_REATTACHED = cast("FrameActionProto", 'COMPONENT_REATTACHED')
    """
    ...
    """
    CONTEXT_CHANGED = cast("FrameActionProto", 'CONTEXT_CHANGED')
    """
    ...
    """
    FRAME_ACTIVATED = cast("FrameActionProto", 'FRAME_ACTIVATED')
    """
    ...
    """
    FRAME_DEACTIVATING = cast("FrameActionProto", 'FRAME_DEACTIVATING')
    """
    ...
    """
    FRAME_UI_ACTIVATED = cast("FrameActionProto", 'FRAME_UI_ACTIVATED')
    """
    an event of this kind is broadcast by an active frame when it is getting UI control (tool control).
    """
    FRAME_UI_DEACTIVATING = cast("FrameActionProto", 'FRAME_UI_DEACTIVATING')
    """
