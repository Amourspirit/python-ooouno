...
class BufferSizeExceededException(IOException_8c450a27):
    ...
    __ooo_full_ns__: str = 'com.sun.star.io.BufferSizeExceededException'
    __ooo_type_name__: str = 'exception'
    __pyunointerface__: str = 'com.sun.star.io.BufferSizeExceededException'
    __pyunostruct__: str = 'com.sun.star.io.BufferSizeExceededException'

    typeName: str = 'com.sun.star.io.BufferSizeExceededException'
    """Literal Constant ``com.sun.star.io.BufferSizeExceededException``"""
