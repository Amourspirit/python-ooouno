...
if typing.TYPE_CHECKING or _DYNAMIC is False:
    ...
    class CertAltNameEntry(object):
        ...
        Note:
            | At runtime CertAltNameEntry will be an actual uno struct however can seamlessly be treated as a regualr class.
            | At design time a class is presumed. This allows for better typings.
            | CertAltNameEntry is a callable and can be treatead as a class and create instances.
        """

        def __init__(self, Type: 'typing.Optional[ExtAltNameType_8c0df5]' = None, Value: typing.Optional[object] = None):
            self._type = Type
            self._value = Value
...
if not typing.TYPE_CHECKING and _DYNAMIC:
    def _dynamic_struct() -> None:
        ...
        def _struct_init(*args, **kwargs):
            struct = uno_helper.create_uno_struct('com.sun.star.security.CertAltNameEntry')
