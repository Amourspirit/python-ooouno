...
class XAccessibleTextAttributes(ABC):
    ...
    **since**
    ...
    @abstractmethod
    def getDefaultAttributes(self, RequestedAttributes: 'typing.List[str]') -> 'typing.List[PropertyValue_c9610c73]':
        """
        ...
        """
    @abstractmethod
    def getRunAttributes(self, Index: int, RequestedAttributes: 'typing.List[str]') -> 'typing.List[PropertyValue_c9610c73]':
        """
