...
class XFont(XInterface_8f010a43):
    ...
    def getCharWidth(self, c: str) -> int:
        ...
        """
    @abstractmethod
    def getCharWidths(self, nFirst: str, nLast: str) -> 'typing.List[int]':
        """
    ...
    def getFontMetric(self) -> 'SimpleFontMetric_d53c0cb9':
        ...
        """
    @abstractmethod
    def getKernPairs(self, Chars1: 'typing.List[str]', Chars2: 'typing.List[str]', Kerns: 'typing.List[int]') -> None:
        """
    ...
    def getStringWidth(self, str: str) -> int:
        ...
        """
    @abstractmethod
    def getStringWidthArray(self, str: str, aDXArray: 'typing.List[int]') -> int:
        """
