...
class XSlideShow(XInterface_8f010a43):
    ...
    **since**
    ...
    def addView(self, xView: 'XSlideShowView_3eb40fa9') -> bool:
        ...
        """
    @abstractmethod
    def displaySlide(self, xSlide: 'XDrawPage_b07a0b57', xDrawPages: 'XDrawPagesSupplier_29650f1e', AnimationNode: 'XAnimationNode_1cf10eb9', aProperties: 'typing.List[PropertyValue_c9610c73]') -> None:
        """
