...
if (not TYPE_CHECKING) and UNO_RUNTIME and UNO_ENVIRONMENT:
    ...
    def _get_class():
        orig_init = None
        ordered_keys = ('Result', 'State', 'Value', 'Name')
        ...
        type_name = 'com.sun.star.beans.GetDirectPropertyTolerantResult'
    ...
    GetDirectPropertyTolerantResult = _get_class()

else:
    if TYPE_CHECKING:
        from com.sun.star.beans import GetDirectPropertyTolerantResult as GetDirectPropertyTolerantResult
    else:
