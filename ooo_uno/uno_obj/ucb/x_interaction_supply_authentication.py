...
class XInteractionSupplyAuthentication(XInteractionContinuation_5af0108e):
    ...
    def canSetUserName(self) -> bool:
        ...
        """
    @abstractmethod
    def getRememberAccountModes(self, Default: 'RememberAuthentication_28a80f31') -> 'typing.List[RememberAuthentication_28a80f31]':
        """
        ...
        * ``Default`` is an out direction argument.
        """
    @abstractmethod
    def getRememberPasswordModes(self, Default: 'RememberAuthentication_28a80f31') -> 'typing.List[RememberAuthentication_28a80f31]':
        """
