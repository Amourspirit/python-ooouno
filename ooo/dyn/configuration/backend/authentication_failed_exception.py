...
if (not TYPE_CHECKING) and UNO_RUNTIME and UNO_ENVIRONMENT:
    ...
    def _get_class():
        orig_init = None
        ordered_keys = ('Message', 'Context', 'BackendException')
    ...
    AuthenticationFailedException = _get_class()

else:
    if TYPE_CHECKING:
        from com.sun.star.configuration.backend import AuthenticationFailedException as AuthenticationFailedException
    else:
