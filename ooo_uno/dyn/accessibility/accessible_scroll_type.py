...
if not TYPE_CHECKING and _DYNAMIC:
    ...
    from ...uno_obj.accessibility.accessible_scroll_type import AccessibleScrollType as AccessibleScrollType_cls
    AccessibleScrollType = AccessibleScrollType_cls
