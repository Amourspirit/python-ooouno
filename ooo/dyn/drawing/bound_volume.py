...
if not TYPE_CHECKING and _DYNAMIC:
    def _dynamic_struct():
        ...
        # Dynamically create uno com.sun.star.drawing.BoundVolume using uno
        global BoundVolume

        def _set_fn_attr(struct):
            type_name = 'com.sun.star.drawing.BoundVolume'
        ...
        def _struct_init(min = UNO_NONE, max = UNO_NONE):
            ns = 'com.sun.star.drawing.BoundVolume'
            if isinstance(min, UBoundVolume):
