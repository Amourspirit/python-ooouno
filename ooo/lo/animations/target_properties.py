...
class TargetProperties(object):
    ...
    def __init__(self, Target: typing.Optional[object] = None, Properties: typing.Optional[typing.Tuple[NamedValue_a37a0af3, ...]] = ()) -> None:
        """
        Constructor
        ...
        if isinstance(Target, TargetProperties):
            oth: TargetProperties = Target
