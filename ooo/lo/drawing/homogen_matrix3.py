...
class HomogenMatrix3(object):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Other Arguments:
            First positinal arg can be another ``HomogenMatrix3`` instance,
                if it is the only argument passed to contructor;
                Otherwise, postitional arguments are treated as ``HomogenMatrix3``
        ...
        key_order = ('Line1', 'Line2', 'Line3')
        arg_len = len(args)
        if arg_len == 1:
            if isinstance(args[0], HomogenMatrix3):
                oth = args[0]
        ...
        if  arg_len > len(key_order):
            raise ValueError("HomogenMatrix3.__init__() To many parameters")
