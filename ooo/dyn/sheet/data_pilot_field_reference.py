    ...
    def _dynamic_struct() -> None:
        ...
        def _struct_init(*args, **kwargs):
            ...
            if arg_len == 1:
                ...
                if isinstance(args[0], UDataPilotFieldReference):
                    struct = uno.createUnoStruct(
                        'com.sun.star.sheet.DataPilotFieldReference', args[0])
                    _set_attr(struct)
                    return struct

            key_order = ('ReferenceType', 'ReferenceField', 'ReferenceItemType', 'ReferenceItemName')
            struct = uno.createUnoStruct('com.sun.star.sheet.DataPilotFieldReference')
