...
class FontRequest(object):
    ...
    **since**
    ...
    Note:
        | At runtime FontRequest will be an actual uno struct however can seamlessly be treated as a regualr class.
        | At design time a class is presumed. This allows for better typings.
        | FontRequest is a callable and can be treatead as a class and create instances.
    """

    def __init__(self, CellSize: typing.Optional[float] = None, FontDescription: 'typing.Optional[FontInfo_bded0be9]' = None, Locale: 'typing.Optional[Locale_70d308fa]' = None, ReferenceAdvancement: typing.Optional[float] = None):
...
def _dynamic_struct() -> None:
    ...
    if ignore == 'True':
        return
    if (not typing.TYPE_CHECKING) and UNO_ENVIRONMENT:
        order = ('CellSize', 'FontDescription', 'Locale', 'ReferenceAdvancement')
        def _struct_init(*args, **kwargs):
            struct = uno_helper.create_uno_struct('com.sun.star.rendering.FontRequest')
