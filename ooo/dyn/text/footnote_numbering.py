...
if not TYPE_CHECKING and _DYNAMIC:
    ...
    class FootnoteNumbering(metaclass=UnoConstMeta, type_name="com.sun.star.text.FootnoteNumbering", name_space="com.sun.star.text"):
        """Dynamic Class. Contains all the constant values of ``com.sun.star.text.FootnoteNumbering``"""
        pass

    class FootnoteNumberingEnum(IntEnum, metaclass=ConstEnumMeta, type_name="com.sun.star.text.FootnoteNumbering", name_space="com.sun.star.text"):
        """Dynamic Enum. Contains all the constant values of ``com.sun.star.text.FootnoteNumbering`` as Enum values"""
        pass
