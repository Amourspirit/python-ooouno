...
class XImageConsumer(XInterface_8f010a43):
    ...
    def init(self, Width: int, Height: int) -> None:
        ...
        """
    @abstractmethod
    def setColorModel(self, BitCount: int, RGBAPal: 'typing.List[int]', RedMask: int, GreenMask: int, BlueMask: int, AlphaMask: int) -> None:
        """
        changes color model for next pixels typically called once after initialization.
        """
    @abstractmethod
    def setPixelsByBytes(self, nX: int, nY: int, nWidth: int, nHeight: int, aProducerData: 'typing.List[int]', nOffset: int, nScanSize: int) -> None:
        """
        ...
        """
    @abstractmethod
    def setPixelsByLongs(self, nX: int, nY: int, nWidth: int, nHeight: int, aProducerData: 'typing.List[int]', nOffset: int, nScanSize: int) -> None:
        """
