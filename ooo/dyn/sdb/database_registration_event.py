...
if (not TYPE_CHECKING) and UNO_RUNTIME and UNO_ENVIRONMENT:
    ...
    def _get_class():
        orig_init = None
        def init(self, Name = UNO_NONE, OldLocation = UNO_NONE, NewLocation = UNO_NONE, **kwargs):
            ...
            if not OldLocation is UNO_NONE:
                if getattr(self, 'OldLocation') != OldLocation:
                    setattr(self, 'OldLocation', OldLocation)
            if not NewLocation is UNO_NONE:
                if getattr(self, 'NewLocation') != NewLocation:
                    setattr(self, 'NewLocation', NewLocation)
    ...
    DatabaseRegistrationEvent = _get_class()
