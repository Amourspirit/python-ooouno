...
if not TYPE_CHECKING and _DYNAMIC:
    def _dynamic_struct():
        import uno
        from com.sun.star.sheet import SolverConstraint as USolverConstraint
        # Dynamically create uno com.sun.star.sheet.SolverConstraint using uno
        global SolverConstraint

        def _set_fn_attr(struct):
            type_name = 'com.sun.star.sheet.SolverConstraint'
        ...
        def _set_attr(struct):
            ...
            struct.__dict__['__ooo_full_ns__'] = 'com.sun.star.sheet.SolverConstraint'
            struct.__dict__['__ooo_type_name__'] = 'struct'

        def _struct_init(Left = UNO_NONE, Operator = UNO_NONE, Right = UNO_NONE):
            ns = 'com.sun.star.sheet.SolverConstraint'
            if isinstance(Left, USolverConstraint):
