...
if (not TYPE_CHECKING) and UNO_RUNTIME and UNO_ENVIRONMENT:
    ...
    def _get_class():
        orig_init = None
        def init(self, Event = UNO_NONE, **kwargs):
            if getattr(Event, "__class__", None) == self.__class__:
                orig_init(self, Event)
                return
            else:
                orig_init(self)
        ...
        type_name = 'com.sun.star.awt.tree.ExpandVetoException'
        ex = uno.getClass(type_name)
        ex.__ooo_ns__ = 'com.sun.star.awt.tree'
    ...
    ExpandVetoException = _get_class()
