...
class XVclContainerPeer(XInterface_8f010a43):
    ...
    def enableDialogControl(self, bEnable: bool) -> None:
        ...
        """
    @abstractmethod
    def setGroup(self, Windows: 'typing.List[XWindow_713b0924]') -> None:
        """
        sets a group.
        """
    @abstractmethod
    def setTabOrder(self, WindowOrder: 'typing.List[XWindow_713b0924]', Tabs: 'typing.List[object]', GroupControl: bool) -> None:
        """
        sets the tab order.
        """
