...
class XSecurityEnvironment(XInterface_8f010a43):
    ...
    **since**
    ...
    @abstractmethod
    def buildCertificatePath(self, beginCert: 'XCertificate_e55b0d3b') -> 'typing.List[XCertificate_e55b0d3b]':
        """
    ...
    def createCertificateFromAscii(self, asciiCertificate: str) -> 'XCertificate_e55b0d3b':
        ...
        """
    @abstractmethod
    def createCertificateFromRaw(self, rawCertificate: 'typing.List[int]') -> 'XCertificate_e55b0d3b':
        """
        ...
        """
    @abstractmethod
    def getAllCertificates(self) -> 'typing.List[XCertificate_e55b0d3b]':
        """
        ...
        **since**
        ...
        """
    @abstractmethod
    def getCertificate(self, issuerName: str, serialNumber: 'typing.List[int]') -> 'XCertificate_e55b0d3b':
        """
    ...
    def getCertificateCharacters(self, xCertificate: 'XCertificate_e55b0d3b') -> int:
        ...
        """
    @abstractmethod
    def getPersonalCertificates(self) -> 'typing.List[XCertificate_e55b0d3b]':
        """
    ...
    def getSecurityEnvironmentInformation(self) -> str:
        ...
        """
    @abstractmethod
    def verifyCertificate(self, xEECertificate: 'XCertificate_e55b0d3b', intermediateCertificates: 'typing.List[XCertificate_e55b0d3b]') -> int:
        """
