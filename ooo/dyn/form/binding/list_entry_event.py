...
if (not TYPE_CHECKING) and UNO_RUNTIME and UNO_ENVIRONMENT:
    ...
    def _get_class():
        orig_init = None
        def init(self, Entries = UNO_NONE, Position = UNO_NONE, Count = UNO_NONE, **kwargs):
            if getattr(Entries, "__class__", None) == self.__class__:
                orig_init(self, Entries)
                return
            else:
                orig_init(self)
            if not Entries is UNO_NONE:
                if getattr(self, 'Entries') != Entries:
        ...
        struct.__ooo_ns__ = 'com.sun.star.form.binding'
