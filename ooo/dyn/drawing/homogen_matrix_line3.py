    ...
    def _dynamic_struct() -> None:
        ...
        def _struct_init(*args, **kwargs):
            ...
            if arg_len == 1:
                ...
                if isinstance(args[0], UHomogenMatrixLine3):
                    struct = uno.createUnoStruct(
                        'com.sun.star.drawing.HomogenMatrixLine3', args[0])
                    _set_attr(struct)
                    return struct

            key_order = ('Column1', 'Column2', 'Column3')
            struct = uno.createUnoStruct('com.sun.star.drawing.HomogenMatrixLine3')
