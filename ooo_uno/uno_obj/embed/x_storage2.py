...
class XStorage2(XStorage_8e460a32):
    ...
    @abstractmethod
    def cloneEncryptedStream(self, sStreamName: str, aEncryptionData: 'typing.List[NamedValue_a37a0af3]') -> 'XStream_678908a4':
        """
        ...
        """
    @abstractmethod
    def openEncryptedStream(self, sStreamName: str, nOpenMode: int, aEncryptionData: 'typing.List[NamedValue_a37a0af3]') -> 'XStream_678908a4':
        """
