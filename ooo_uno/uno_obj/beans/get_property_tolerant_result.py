...
if typing.TYPE_CHECKING or _DYNAMIC is False:
    ...
    class GetPropertyTolerantResult(object):
        ...
        Note:
            | At runtime GetPropertyTolerantResult will be an actual uno struct however can seamlessly be treated as a regualr class.
            | At design time a class is presumed. This allows for better typings.
            | GetPropertyTolerantResult is a callable and can be treatead as a class and create instances.
        """

        def __init__(self, Result: typing.Optional[int] = None, State: 'typing.Optional[PropertyState_c97b0c77]' = None, Value: typing.Optional[object] = None):
            self._result = Result
            self._state = State
            self._value = Value
...
if not typing.TYPE_CHECKING and _DYNAMIC:
    def _dynamic_struct() -> None:
        ...
        order = ('Result', 'State', 'Value')

        def _struct_init(*args, **kwargs):
            struct = uno_helper.create_uno_struct('com.sun.star.beans.GetPropertyTolerantResult')
