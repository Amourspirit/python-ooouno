...
class XUpdateInformationProvider(ABC):
    ...
    **since**
    ...
    def cancel(self) -> None:
        ...
        """
    @abstractmethod
    def getUpdateInformation(self, repositories: 'typing.List[str]', extensionId: str) -> 'typing.List[XElement_a33d0ae9]':
        """
        ...
        """
    @abstractmethod
    def getUpdateInformationEnumeration(self, repositories: 'typing.List[str]', extensionId: str) -> 'XEnumeration_f2180daa':
        """
        get update information for a specific extension or all available information from a repository.
