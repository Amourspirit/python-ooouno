...
class Symbol(object):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Other Arguments:
            First positinal arg can be another ``Symbol`` instance,
                if it is the only argument passed to contructor;
                Otherwise, postitional arguments are treated as ``Symbol``
        ...
        self._standard_symbol = None
        self._graphic = None
        self._size = None
        self._border_color = None
        self._fill_color = None

        key_order = ('Style', 'PolygonCoords', 'StandardSymbol', 'Graphic', 'Size', 'BorderColor', 'FillColor')
        arg_len = len(args)
        if arg_len == 1:
        ...
        if  arg_len > len(key_order):
            raise ValueError("Symbol.__init__() To many parameters")
