...
class MailAttachment(object):
    ...
    **since**
    ...
    def __init__(self, *args, **kwargs):
        ...
        Other Arguments:
            First positinal arg can be another ``MailAttachment`` instance,
                if it is the only argument passed to contructor;
                Otherwise, postitional arguments are treated as ``MailAttachment``
        ...
        arg_len = len(args)
        if arg_len == 1:
            if isinstance(args[0], MailAttachment):
                oth = args[0]
