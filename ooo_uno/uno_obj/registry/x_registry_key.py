...
class XRegistryKey(XInterface_8f010a43):
    ...
    def deleteLink(self, rLinkName: str) -> None:
        ...
        """
    @abstractmethod
    def getAsciiListValue(self) -> 'typing.List[str]':
        """
    ...
    def getAsciiValue(self) -> str:
        ...
        """
    @abstractmethod
    def getBinaryValue(self) -> 'typing.List[int]':
        """
        ...
        """
    @abstractmethod
    def getKeyNames(self) -> 'typing.List[str]':
        """
    ...
    def getLinkTarget(self, rLinkName: str) -> str:
        ...
        """
    @abstractmethod
    def getLongListValue(self) -> 'typing.List[int]':
        """
    ...
    def getResolvedName(self, aKeyName: str) -> str:
        ...
        """
    @abstractmethod
    def getStringListValue(self) -> 'typing.List[str]':
        """
    ...
    def openKey(self, aKeyName: str) -> 'XRegistryKey':
        ...
        """
    @abstractmethod
    def openKeys(self) -> 'typing.List[XRegistryKey]':
        """
        ...
        """
    @abstractmethod
    def setAsciiListValue(self, seqValue: 'typing.List[str]') -> None:
        """
    ...
    def setAsciiValue(self, value: str) -> None:
        ...
        """
    @abstractmethod
    def setBinaryValue(self, value: 'typing.List[int]') -> None:
        """
        ...
        """
    @abstractmethod
    def setLongListValue(self, seqValue: 'typing.List[int]') -> None:
        """
    ...
    def setLongValue(self, value: int) -> None:
        ...
        """
    @abstractmethod
    def setStringListValue(self, seqValue: 'typing.List[str]') -> None:
        """
