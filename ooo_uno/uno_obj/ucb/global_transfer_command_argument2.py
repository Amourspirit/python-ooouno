...
if typing.TYPE_CHECKING or _DYNAMIC is False:
    ...
    class GlobalTransferCommandArgument2(GlobalTransferCommandArgument_9ae711da):
        ...
        Note:
            | At runtime GlobalTransferCommandArgument2 will be an actual uno struct however can seamlessly be treated as a regualr class.
            | At design time a class is presumed. This allows for better typings.
            | GlobalTransferCommandArgument2 is a callable and can be treatead as a class and create instances.
        """
...
if not typing.TYPE_CHECKING and _DYNAMIC:
    def _dynamic_struct() -> None:
        ...
        def _struct_init(*args, **kwargs):
            struct = uno_helper.create_uno_struct('com.sun.star.ucb.GlobalTransferCommandArgument2')
