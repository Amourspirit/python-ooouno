    ...
    def _dynamic_struct() -> None:
        ...
        def _struct_init(*args, **kwargs):
            ...
            if arg_len == 1:
                ...
                if isinstance(args[0], UPropertyCategoryDescriptor):
                    struct = uno.createUnoStruct(
                        'com.sun.star.inspection.PropertyCategoryDescriptor', args[0])
                    _set_attr(struct)
                    return struct

            key_order = ('ProgrammaticName', 'UIName', 'HelpURL')
            struct = uno.createUnoStruct('com.sun.star.inspection.PropertyCategoryDescriptor')
