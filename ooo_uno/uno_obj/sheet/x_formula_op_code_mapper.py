...
class XFormulaOpCodeMapper(ABC):
    ...
    @abstractmethod
    def getAvailableMappings(self, Language: int, Groups: int) -> 'typing.List[FormulaOpCodeMapEntry_37da0f61]':
        """
        ...
        """
    @abstractmethod
    def getMappings(self, Names: 'typing.List[str]', Language: int) -> 'typing.List[FormulaToken_bd1c0bf8]':
        """
