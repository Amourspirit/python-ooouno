...
class XNumberFormatCode(XInterface_8f010a43):
    ...
    @abstractmethod
    def getAllFormatCode(self, nFormatUsage: int, rLocale: 'Locale_70d308fa') -> 'typing.List[NumberFormatCode_d9a00c95]':
        """
        returns all format codes for a given nFormatUsage and locale.
        """
    @abstractmethod
    def getAllFormatCodes(self, rLocale: 'Locale_70d308fa') -> 'typing.List[NumberFormatCode_d9a00c95]':
        """
