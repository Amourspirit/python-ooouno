...
from com.sun.star.text.RubyAdjust import RubyAdjustProto
...
class RubyAdjust(Enum):
    ...
    BLOCK = cast(RubyAdjustProto, 'BLOCK')
    """
    adjusted to both borders / stretched
    """
    CENTER = cast(RubyAdjustProto, 'CENTER')
    """
    the object is adjusted to the center.
    
    centric adjusted.
    """
    INDENT_BLOCK = cast(RubyAdjustProto, 'INDENT_BLOCK')
    """
    adjusted to both borders except for a small indent on both sides
    """
    LEFT = cast(RubyAdjustProto, 'LEFT')
    """
    ...
    """
    RIGHT = cast(RubyAdjustProto, 'RIGHT')
    """
