...
if not TYPE_CHECKING and _DYNAMIC:
    ...
    from com.sun.star.drawing.TextAnimationDirection import (DOWN, LEFT, RIGHT, UP)
    ...
    def _get_enum():
        ...
        result = type('TextAnimationDirection', (object,), _dict)
        return result

    TextAnimationDirection = _get_enum()
else:
