...
class InsertedObjectInfo(object):
    ...
    def __init__(self, Object: typing.Optional[XEmbeddedObject_ddee0cbe] = None, Options: typing.Optional[typing.Tuple[NamedValue_a37a0af3, ...]] = ()) -> None:
        """
        Constructor
        ...
        if isinstance(Object, InsertedObjectInfo):
            oth: InsertedObjectInfo = Object
