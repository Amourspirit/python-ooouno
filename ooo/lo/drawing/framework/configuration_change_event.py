...
class ConfigurationChangeEvent(EventObject_a3d70b03):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Other Arguments:
            First positinal arg can be another ``ConfigurationChangeEvent`` instance,
                if it is the only argument passed to contructor;
                Otherwise, postitional arguments are treated as ``ConfigurationChangeEvent``
        ...
        arg_len = len(args)
        if arg_len == 1:
            if isinstance(args[0], ConfigurationChangeEvent):
                oth = args[0]
