...
if typing.TYPE_CHECKING or _DYNAMIC is False:
    ...
    class SectionFileLink(object):
        ...
        Note:
            | At runtime SectionFileLink will be an actual uno struct however can seamlessly be treated as a regualr class.
            | At design time a class is presumed. This allows for better typings.
            | SectionFileLink is a callable and can be treatead as a class and create instances.
        """

        def __init__(self, FileURL: typing.Optional[str] = None, FilterName: typing.Optional[str] = None):
...
if not typing.TYPE_CHECKING and _DYNAMIC:
    def _dynamic_struct() -> None:
        ...
        order = ('FileURL', 'FilterName')

        def _struct_init(*args, **kwargs):
            struct = uno_helper.create_uno_struct('com.sun.star.text.SectionFileLink')
