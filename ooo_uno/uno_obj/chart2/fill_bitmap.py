...
if typing.TYPE_CHECKING or _DYNAMIC is False:
    ...
    class FillBitmap(object):
        ...
        Note:
            | At runtime FillBitmap will be an actual uno struct however can seamlessly be treated as a regualr class.
            | At design time a class is presumed. This allows for better typings.
            | FillBitmap is a callable and can be treatead as a class and create instances.
        """

        def __init__(self, aBitmapMode: 'typing.Optional[BitmapMode_bced0bd6]' = None, aOffset: 'typing.Optional[Point_5fb2085e]' = None, aPositionOffset: 'typing.Optional[Point_5fb2085e]' = None, aRectanglePoint: 'typing.Optional[RectanglePoint_f0ff0d93]' = None, aSize: 'typing.Optional[Size_576707ef]' = None, aURL: typing.Optional[str] = None, bLogicalSize: typing.Optional[bool] = None):
...
if not typing.TYPE_CHECKING and _DYNAMIC:
    def _dynamic_struct() -> None:
        ...
        global FillBitmap
        order = ('aBitmapMode', 'aOffset', 'aPositionOffset', 'aRectanglePoint', 'aSize', 'aURL', 'bLogicalSize')

        def _struct_init(*args, **kwargs):
            struct = uno_helper.create_uno_struct('com.sun.star.chart2.FillBitmap')
