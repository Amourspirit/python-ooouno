...
class XPrimitive2DRenderer(XInterface_8f010a43):
    ...
    @abstractmethod
    def rasterize(self, Primitive2DSequence: 'typing.List[XPrimitive2D_d5730c6d]', aViewInformationSequence: 'typing.List[PropertyValue_c9610c73]', DPIX: int, DPIY: int, Range: 'RealRectangle2D_d9b0e03', MaximumQuadraticPixels: int) -> 'XBitmap_b1b70b7b':
        """
