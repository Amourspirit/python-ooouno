...
if typing.TYPE_CHECKING or _DYNAMIC is False:
    ...
    class RealBezierSegment2D(object):
        ...
        **since**
        ...
        Note:
            | At runtime RealBezierSegment2D will be an actual uno struct however can seamlessly be treated as a regualr class.
            | At design time a class is presumed. This allows for better typings.
            | RealBezierSegment2D is a callable and can be treatead as a class and create instances.
        """

        def __init__(self, C1x: typing.Optional[float] = None, C1y: typing.Optional[float] = None, C2x: typing.Optional[float] = None, C2y: typing.Optional[float] = None, Px: typing.Optional[float] = None, Py: typing.Optional[float] = None):
            self._c1x = C1x
            self._c1y = C1y
            self._c2x = C2x
            self._c2y = C2y
...
if not typing.TYPE_CHECKING and _DYNAMIC:
    def _dynamic_struct() -> None:
        ...
        def _struct_init(*args, **kwargs):
            struct = uno_helper.create_uno_struct('com.sun.star.geometry.RealBezierSegment2D')
