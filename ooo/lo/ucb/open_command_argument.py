...
class OpenCommandArgument(object):
    ...
    def __init__(self, Mode: typing.Optional[int] = 0, Priority: typing.Optional[int] = 0, Sink: typing.Optional[XInterface_8f010a43] = None, Properties: typing.Optional[typing.Tuple[Property_8f4e0a76, ...]] = ()) -> None:
        """
        Constructor
        ...
        if isinstance(Mode, OpenCommandArgument):
            oth: OpenCommandArgument = Mode
            self.Mode = oth.Mode
