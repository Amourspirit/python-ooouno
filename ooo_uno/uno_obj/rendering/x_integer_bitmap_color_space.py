...
class XIntegerBitmapColorSpace(XColorSpace_e3940d09):
    ...
    @abstractmethod
    def convertFromIntegerColorSpace(self, deviceColor: 'typing.List[int]', targetColorSpace: 'XColorSpace_e3940d09') -> 'typing.List[ColorComponent_e4c0e78]':
        """
        ...
        """
    @abstractmethod
    def convertIntegerFromARGB(self, rgbColor: 'typing.List[ARGBColor_c6ee0be1]') -> 'typing.List[int]':
        """
        ...
        """
    @abstractmethod
    def convertIntegerFromPARGB(self, rgbColor: 'typing.List[ARGBColor_c6ee0be1]') -> 'typing.List[int]':
        """
        ...
        """
    @abstractmethod
    def convertIntegerFromRGB(self, rgbColor: 'typing.List[RGBColor_bbdf0ba0]') -> 'typing.List[int]':
        """
        ...
        """
    @abstractmethod
    def convertIntegerToARGB(self, deviceColor: 'typing.List[int]') -> 'typing.List[ARGBColor_c6ee0be1]':
        """
        ...
        """
    @abstractmethod
    def convertIntegerToPARGB(self, deviceColor: 'typing.List[int]') -> 'typing.List[ARGBColor_c6ee0be1]':
        """
        ...
        """
    @abstractmethod
    def convertIntegerToRGB(self, deviceColor: 'typing.List[int]') -> 'typing.List[RGBColor_bbdf0ba0]':
        """
        ...
        """
    @abstractmethod
    def convertToIntegerColorSpace(self, deviceColor: 'typing.List[int]', targetColorSpace: 'XIntegerBitmapColorSpace') -> 'typing.List[int]':
        """
    ...
    def getBitsPerPixel(self) -> int:
        ...
        """
    @abstractmethod
    def getComponentBitCounts(self) -> 'typing.List[int]':
        """
