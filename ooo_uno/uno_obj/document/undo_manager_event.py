...
if typing.TYPE_CHECKING or _DYNAMIC is False:
    ...
    class UndoManagerEvent(EventObject_a3d70b03):
        ...
        **since**
        ...
        Note:
            | At runtime UndoManagerEvent will be an actual uno struct however can seamlessly be treated as a regualr class.
            | At design time a class is presumed. This allows for better typings.
            | UndoManagerEvent is a callable and can be treatead as a class and create instances.
        """

        def __init__(self, UndoActionTitle: typing.Optional[str] = None, UndoContextDepth: typing.Optional[int] = None):
...
if not typing.TYPE_CHECKING and _DYNAMIC:
    def _dynamic_struct() -> None:
        ...
        order = ('UndoActionTitle', 'UndoContextDepth')

        def _struct_init(*args, **kwargs):
            struct = uno_helper.create_uno_struct('com.sun.star.document.UndoManagerEvent')
