...
class FontMetrics(object):
    ...
    **since**
    ...
    def __init__(self, *args, **kwargs):
        ...
        Other Arguments:
            First positinal arg can be another ``FontMetrics`` instance,
                if it is the only argument passed to contructor;
                Otherwise, postitional arguments are treated as ``FontMetrics``
        ...
        self._ascent = None
        self._descent = None
        self._internal_leading = None
        self._external_leading = None
        self._reference_char_size = None
        self._underline_offset = None
        self._strike_through_offset = None

        key_order = ('Ascent', 'Descent', 'InternalLeading', 'ExternalLeading', 'ReferenceCharSize', 'UnderlineOffset', 'StrikeThroughOffset')
        arg_len = len(args)
        if arg_len == 1:
            if isinstance(args[0], FontMetrics):
                oth = args[0]
