...
class XTextLayout(XInterface_8f010a43):
    ...
    **since**
    ...
    @abstractmethod
    def applyLogicalAdvancements(self, aAdvancements: 'typing.List[float]') -> None:
        """
        ...
        """
    @abstractmethod
    def combinedJustify(self, aNextLayouts: 'typing.List[XTextLayout]', nSize: float) -> float:
        """
    ...
    def justify(self, nSize: float) -> float:
        ...
        """
    @abstractmethod
    def queryInkMeasures(self) -> 'typing.List[RealRectangle2D_d9b0e03]':
        """
        ...
        """
    @abstractmethod
    def queryLogicalAdvancements(self) -> 'typing.List[float]':
        """
    ...
    def queryLogicalHighlighting(self, nStartIndex: int, nEndIndex: int) -> 'XPolyPolygon2D_e1b0e20':
        ...
        """
    @abstractmethod
    def queryMeasures(self) -> 'typing.List[RealRectangle2D_d9b0e03]':
        """
    ...
    def queryTextBounds(self) -> 'RealRectangle2D_d9b0e03':
        ...
        """
    @abstractmethod
    def queryTextShapes(self) -> 'typing.List[XPolyPolygon2D_e1b0e20]':
        """
