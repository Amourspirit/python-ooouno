...
class XEmbedObjectClipboardCreator(XInterface_8f010a43):
    ...
    @abstractmethod
    def createInstanceInitFromClipboard(self, xStorage: 'XStorage_8e460a32', sEntryName: str, aObjectArgs: 'typing.List[PropertyValue_c9610c73]') -> 'InsertedObjectInfo_a0e0e26':
        """
