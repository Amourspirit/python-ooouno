...
class XSortedDynamicResultSetFactory(XInterface_8f010a43):
    ...
    @abstractmethod
    def createSortedDynamicResultSet(self, Source: 'XDynamicResultSet_e0360d0a', Info: 'typing.List[NumberedSortingInfo_fd0e0de6]', CompareFactory: 'XAnyCompareFactory_ec090d61') -> 'XDynamicResultSet_e0360d0a':
        """
