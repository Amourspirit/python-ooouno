...
class XCachedDynamicResultSetStubFactory(XInterface_8f010a43):
    ...
    @abstractmethod
    def connectToCache(self, Source: 'XDynamicResultSet_e0360d0a', TargetCache: 'XDynamicResultSet_e0360d0a', SortingInfo: 'typing.List[NumberedSortingInfo_fd0e0de6]', CompareFactory: 'XAnyCompareFactory_ec090d61') -> None:
        """
