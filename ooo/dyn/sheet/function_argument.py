...
if (not TYPE_CHECKING) and UNO_RUNTIME and UNO_ENVIRONMENT:
    ...
    def _get_class():
        orig_init = None
        def init(self, Name = UNO_NONE, Description = UNO_NONE, IsOptional = UNO_NONE):
            ...
            if not IsOptional is UNO_NONE:
                if getattr(self, 'IsOptional') != IsOptional:
                    setattr(self, 'IsOptional', IsOptional)
