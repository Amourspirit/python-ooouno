...
if typing.TYPE_CHECKING or _DYNAMIC is False:
    ...
    class Date(object):
        ...
        def __init__(self, Day: typing.Optional[int] = None, Month: typing.Optional[int] = None, Year: typing.Optional[int] = None):
            self._day = Day
            self._month = Month
            self._year = Year
...
if not typing.TYPE_CHECKING and _DYNAMIC:
    def _dynamic_struct() -> None:
        ...
        def _struct_init(*args, **kwargs):
            struct = uno_helper.create_uno_struct('com.sun.star.util.Date')
