...
class SortingInfo(object):
    ...
    Note:
        | At runtime SortingInfo will be an actual uno struct however can seamlessly be treated as a regualr class.
        | At design time a class is presumed. This allows for better typings.
        | SortingInfo is a callable and can be treatead as a class and create instances.
    """

    def __init__(self, Ascending: typing.Optional[bool] = None, PropertyName: typing.Optional[str] = None):
...
def _dynamic_struct() -> None:
    ...
    if ignore == 'True':
        return
    if (not typing.TYPE_CHECKING) and UNO_ENVIRONMENT:
        order = ('Ascending', 'PropertyName')
        def _struct_init(*args, **kwargs):
            struct = uno_helper.create_uno_struct('com.sun.star.ucb.SortingInfo')
