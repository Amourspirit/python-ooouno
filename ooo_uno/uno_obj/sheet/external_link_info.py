...
if typing.TYPE_CHECKING or _DYNAMIC is False:
    ...
    class ExternalLinkInfo(object):
        ...
        **since**
        ...
        Note:
            | At runtime ExternalLinkInfo will be an actual uno struct however can seamlessly be treated as a regualr class.
            | At design time a class is presumed. This allows for better typings.
            | ExternalLinkInfo is a callable and can be treatead as a class and create instances.
        """

        def __init__(self, Data: typing.Optional[object] = None, Type: typing.Optional[int] = None):
            self._data = Data
            self._type = Type
...
if not typing.TYPE_CHECKING and _DYNAMIC:
    def _dynamic_struct() -> None:
        ...
        def _struct_init(*args, **kwargs):
            struct = uno_helper.create_uno_struct('com.sun.star.sheet.ExternalLinkInfo')
