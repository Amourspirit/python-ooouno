...
if not TYPE_CHECKING and _DYNAMIC:
    ...
    if hasattr(FormulaMapGroupSpecialOffset, '_constants') and isinstance(FormulaMapGroupSpecialOffset._constants, dict):
        FormulaMapGroupSpecialOffset._constants['__ooo_ns__'] = 'com.sun.star.sheet'
        FormulaMapGroupSpecialOffset._constants['__ooo_full_ns__'] = 'com.sun.star.sheet.FormulaMapGroupSpecialOffset'
        FormulaMapGroupSpecialOffset._constants['__ooo_type_name__'] = 'const'
    def build_enum():
        global FormulaMapGroupSpecialOffsetEnum
        ls = [f for f in dir(FormulaMapGroupSpecialOffset) if not callable(getattr(FormulaMapGroupSpecialOffset, f)) and not f.startswith('__')]
        _dict = {}
        for name in ls:
            _dict[name] = getattr(FormulaMapGroupSpecialOffset, name)
        FormulaMapGroupSpecialOffsetEnum = IntEnum('FormulaMapGroupSpecialOffsetEnum', _dict)
    build_enum()
else:
    ...
    class FormulaMapGroupSpecialOffsetEnum(IntEnum):
        ...
        **since**
        ...
        WHITESPACE = FormulaMapGroupSpecialOffset.WHITESPACE
        """
        Formula tokens containing the op-code obtained from this offset describe whitespace characters within the string representation of a formula.
