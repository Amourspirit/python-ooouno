...
if (not TYPE_CHECKING) and UNO_RUNTIME and UNO_ENVIRONMENT:
    ...
    def _get_class():
        orig_init = None
        ordered_keys = ('AffineTransform', 'Alpha', 'NumberOfHatchPolygons', 'Bitmap', 'Gradient', 'Hatching', 'HatchAttributes', 'RepeatModeX', 'RepeatModeY')
    ...
    if TYPE_CHECKING:
        from com.sun.star.rendering import Texture as Texture
    else:
