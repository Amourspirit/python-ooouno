...
if not TYPE_CHECKING and _DYNAMIC:
    def _dynamic_struct():
        import uno
        from com.sun.star.sdb.application import NamedDatabaseObject as UNamedDatabaseObject
        # Dynamically create uno com.sun.star.sdb.application.NamedDatabaseObject using uno
        global NamedDatabaseObject

        def _set_fn_attr(struct):
            type_name = 'com.sun.star.sdb.application.NamedDatabaseObject'
        ...
        def _set_attr(struct):
            ...
            struct.__dict__['__ooo_full_ns__'] = 'com.sun.star.sdb.application.NamedDatabaseObject'
            struct.__dict__['__ooo_type_name__'] = 'struct'

        def _struct_init(Type = UNO_NONE, Name = UNO_NONE):
            ns = 'com.sun.star.sdb.application.NamedDatabaseObject'
            if isinstance(Type, UNamedDatabaseObject):
