...
class AttributeData(object):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Other Arguments:
            First positinal arg can be another ``AttributeData`` instance,
                if it is the only argument passed to contructor;
                Otherwise, postitional arguments are treated as ``AttributeData``
        ...
        arg_len = len(args)
        if arg_len == 1:
            if isinstance(args[0], AttributeData):
                oth = args[0]
