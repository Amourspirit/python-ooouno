...
class Gradient(object):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Other Arguments:
            First positinal arg can be another ``Gradient`` instance,
                if it is the only argument passed to contructor;
                Otherwise, postitional arguments are treated as ``Gradient``
        ...
        self._x_offset = None
        self._y_offset = None
        self._start_intensity = None
        self._end_intensity = None
