...
class XIeeeFloatBitmap(XIeeeFloatReadOnlyBitmap_ad4b1207):
    ...
    @abstractmethod
    def setData(self, data: 'typing.List[float]', bitmapLayout: 'FloatingPointBitmapLayout_c66812df', rect: 'IntegerRectangle2D_3c5c0f4d') -> None:
        """
        ...
        """
    @abstractmethod
    def setPixel(self, color: 'typing.List[float]', bitmapLayout: 'FloatingPointBitmapLayout_c66812df', pos: 'IntegerPoint2D_8f0dc2') -> None:
        """
