    ...
    def _dynamic_struct() -> None:
        ...
        def _struct_init(*args, **kwargs):
            ...
            if arg_len == 1:
                ...
                if isinstance(args[0], ULinguServiceEvent):
                    struct = uno.createUnoStruct(
                        'com.sun.star.linguistic2.LinguServiceEvent', args[0])
                    _set_attr(struct)
                    return struct

            key_order = ('nEvent',)
            struct = uno.createUnoStruct('com.sun.star.linguistic2.LinguServiceEvent')
