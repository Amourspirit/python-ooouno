...
class SecurityException(RuntimeException_d7390ced):
    ...
    __ooo_full_ns__: str = 'com.sun.star.uno.SecurityException'
    __ooo_type_name__: str = 'exception'
    __pyunointerface__: str = 'com.sun.star.uno.SecurityException'
    __pyunostruct__: str = 'com.sun.star.uno.SecurityException'

    typeName: str = 'com.sun.star.uno.SecurityException'
    """Literal Constant ``com.sun.star.uno.SecurityException``"""
