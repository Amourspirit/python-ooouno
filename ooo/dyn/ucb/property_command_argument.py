...
if (not TYPE_CHECKING) and UNO_RUNTIME and UNO_ENVIRONMENT:
    ...
    def _get_class():
        orig_init = None
        def init(self, Property = UNO_NONE, DefaultValue = UNO_NONE):
            ...
            if not DefaultValue is UNO_NONE:
                if getattr(self, 'DefaultValue') != DefaultValue:
                    setattr(self, 'DefaultValue', DefaultValue)

        type_name = 'com.sun.star.ucb.PropertyCommandArgument'
    ...
    PropertyCommandArgument = _get_class()
