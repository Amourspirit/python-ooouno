...
class EnhancedCustomShapePath(ABC):
    ...
    def TextPathAllowed(self) -> bool:
        ...
        """
    @abstractproperty
    def Coordinates(self) -> 'typing.List[EnhancedCustomShapeParameterPair_262914a3]':
        """
        This property is specifying the points that makes the geometry of the shape.
        """
    @abstractproperty
    def GluePointLeavingDirections(self) -> 'typing.List[float]':
        """
        This property specifies GluePoint leaving directions.
        """
    @abstractproperty
    def GluePoints(self) -> 'typing.List[EnhancedCustomShapeParameterPair_262914a3]':
        """
        This property specifies custom glue points.
        """
    @abstractproperty
    def Segments(self) -> 'typing.List[EnhancedCustomShapeSegment_b07b1249]':
        """
        This property specifies the commands and the way the Coordinates have to be interpreted.
        """
    @abstractproperty
    def SubViewSize(self) -> 'typing.List[Size_576707ef]':
        """
        This property specifies view size per sub path.
        """
    @abstractproperty
    def TextFrames(self) -> 'typing.List[EnhancedCustomShapeTextFrame_d6321306]':
        """
