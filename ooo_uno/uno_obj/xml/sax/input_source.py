...
class InputSource(object):
    ...
    Note:
        | At runtime InputSource will be an actual uno struct however can seamlessly be treated as a regualr class.
        | At design time a class is presumed. This allows for better typings.
        | InputSource is a callable and can be treatead as a class and create instances.
    """

    def __init__(self, aInputStream: 'typing.Optional[XInputStream_98d40ab4]' = None, sEncoding: typing.Optional[str] = None, sPublicId: typing.Optional[str] = None, sSystemId: typing.Optional[str] = None):
...
def _dynamic_struct() -> None:
    ...
    if ignore == 'True':
        return
    if (not typing.TYPE_CHECKING) and UNO_ENVIRONMENT:
        order = ('aInputStream', 'sEncoding', 'sPublicId', 'sSystemId')
        def _struct_init(*args, **kwargs):
            struct = uno_helper.create_uno_struct('com.sun.star.xml.sax.InputSource')
