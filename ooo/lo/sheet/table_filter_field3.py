...
class TableFilterField3(object):
    ...
    **since**
    ...
    def __init__(self, Connection: typing.Optional[FilterConnection_f01f0d97] = FilterConnection_f01f0d97.AND, Field: typing.Optional[int] = 0, Operator: typing.Optional[int] = 0, Values: typing.Optional[typing.Tuple[FilterFieldValue_ef2a0d68, ...]] = ()) -> None:
        """
        Constructor
        ...
        if isinstance(Connection, TableFilterField3):
            oth: TableFilterField3 = Connection
