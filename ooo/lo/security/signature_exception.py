...
class SignatureException(CryptographyException_735a113b):
    ...
    __ooo_full_ns__: str = 'com.sun.star.security.SignatureException'
    __ooo_type_name__: str = 'exception'
    __pyunointerface__: str = 'com.sun.star.security.SignatureException'
    __pyunostruct__: str = 'com.sun.star.security.SignatureException'
