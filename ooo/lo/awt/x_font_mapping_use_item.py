...
class XFontMappingUseItem(object):
    ...
    **since**
    ...
    def __init__(self, originalFont: typing.Optional[str] = '', usedFonts: typing.Optional[typing.Tuple[str, ...]] = (), count: typing.Optional[int] = 0) -> None:
        """
        Constructor
        ...
        if isinstance(originalFont, XFontMappingUseItem):
            oth: XFontMappingUseItem = originalFont
