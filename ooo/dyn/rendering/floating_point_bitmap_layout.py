    ...
    def _dynamic_struct() -> None:
        ...
        def _struct_init(*args, **kwargs):
            ...
            if arg_len == 1:
                ...
                if isinstance(args[0], UFloatingPointBitmapLayout):
                    struct = uno.createUnoStruct(
                        'com.sun.star.rendering.FloatingPointBitmapLayout', args[0])
                    _set_attr(struct)
                    return struct

            key_order = ('ScanLines', 'ScanLineBytes', 'ScanLineStride', 'PlaneStride', 'ColorSpace', 'NumComponents', 'Endianness', 'Format')
            struct = uno.createUnoStruct('com.sun.star.rendering.FloatingPointBitmapLayout')
