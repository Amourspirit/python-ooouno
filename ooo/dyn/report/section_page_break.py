...
if not TYPE_CHECKING and _DYNAMIC:
    ...
    class SectionPageBreak(metaclass=UnoConstMeta, type_name="com.sun.star.report.SectionPageBreak", name_space="com.sun.star.report"):
        """Dynamic Class. Contains all the constant values of ``com.sun.star.report.SectionPageBreak``"""
        pass

    class SectionPageBreakEnum(IntEnum, metaclass=ConstEnumMeta, type_name="com.sun.star.report.SectionPageBreak", name_space="com.sun.star.report"):
        """Dynamic Enum. Contains all the constant values of ``com.sun.star.report.SectionPageBreak`` as Enum values"""
        pass
