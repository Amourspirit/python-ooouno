...
class TableBorder2(object):
    ...
    **since**
    ...
    def __init__(self, *args, **kwargs):
        ...
        Other Arguments:
            First positinal arg can be another ``TableBorder2`` instance,
                if it is the only argument passed to contructor;
                Otherwise, postitional arguments are treated as ``TableBorder2``
        ...
        arg_len = len(args)
        if arg_len == 1:
            if isinstance(args[0], TableBorder2):
                oth = args[0]
        ...
        if  arg_len > len(key_order):
            raise ValueError("TableBorder2.__init__() To many parameters")
