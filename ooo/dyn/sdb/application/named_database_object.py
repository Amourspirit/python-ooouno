    ...
    def _dynamic_struct() -> None:
        ...
        def _struct_init(*args, **kwargs):
            ...
            if arg_len == 1:
                ...
                if isinstance(args[0], UNamedDatabaseObject):
                    struct = uno.createUnoStruct(
                        'com.sun.star.sdb.application.NamedDatabaseObject', args[0])
                    _set_attr(struct)
                    return struct

            key_order = ('Type', 'Name')
            struct = uno.createUnoStruct('com.sun.star.sdb.application.NamedDatabaseObject')
