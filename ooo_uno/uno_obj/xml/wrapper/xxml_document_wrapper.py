...
class XXMLDocumentWrapper(XInterface_8f010a43):
    ...
    @abstractmethod
    def clearUselessData(self, node: 'XXMLElementWrapper_66c0107c', reservedDescendants: 'typing.List[XXMLElementWrapper_66c0107c]', stopAtNode: 'XXMLElementWrapper_66c0107c') -> None:
        """
