...
class XTypeDescriptionEnumerationAccess(XInterface_8f010a43):
    ...
    **since**
    ...
    @abstractmethod
    def createTypeDescriptionEnumeration(self, moduleName: str, types: 'typing.List[TypeClass_853109f2]', depth: 'TypeDescriptionSearchDepth_ef6a13a4') -> 'XTypeDescriptionEnumeration_33e1438':
        """
