...
if (not TYPE_CHECKING) and UNO_RUNTIME and UNO_ENVIRONMENT:
    ...
    def _get_class():
        orig_init = None
        def init(self, Locale = UNO_NONE, Format = UNO_NONE, Style = UNO_NONE):
            if getattr(Locale, "__class__", None) == self.__class__:
                orig_init(self, Locale)
                return
            else:
                orig_init(self)
    ...
    NativeNumberXmlAttributes = _get_class()
