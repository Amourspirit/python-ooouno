...
if typing.TYPE_CHECKING or _DYNAMIC is False:
    ...
    class ProofreadingResult(object):
        ...
        **since**
        ...
        Note:
            | At runtime ProofreadingResult will be an actual uno struct however can seamlessly be treated as a regualr class.
            | At design time a class is presumed. This allows for better typings.
            | ProofreadingResult is a callable and can be treatead as a class and create instances.
        """

        def __init__(self, aDocumentIdentifier: typing.Optional[str] = None, aErrors: 'typing.Optional[typing.List[SingleProofreadingError_c54812c1]]' = None, aLocale: 'typing.Optional[Locale_70d308fa]' = None, aProperties: 'typing.Optional[typing.List[PropertyValue_c9610c73]]' = None, aText: typing.Optional[str] = None, nBehindEndOfSentencePosition: typing.Optional[int] = None, nStartOfNextSentencePosition: typing.Optional[int] = None, nStartOfSentencePosition: typing.Optional[int] = None, xFlatParagraph: 'typing.Optional[XFlatParagraph_c8310c42]' = None, xProofreader: 'typing.Optional[XProofreader_dab0e46]' = None):
        ...
        @property
        def aErrors(self) -> 'typing.List[SingleProofreadingError_c54812c1]':
            return self._a_errors
        
        @aErrors.setter
        def aErrors(self, value: 'typing.List[SingleProofreadingError_c54812c1]') -> None:
...
if not typing.TYPE_CHECKING and _DYNAMIC:
    def _dynamic_struct() -> None:
        ...
        order = ('aDocumentIdentifier', 'aErrors', 'aLocale', 'aProperties', 'aText', 'nBehindEndOfSentencePosition', 'nStartOfNextSentencePosition', 'nStartOfSentencePosition', 'xFlatParagraph', 'xProofreader')

        def _struct_init(*args, **kwargs):
            struct = uno_helper.create_uno_struct('com.sun.star.linguistic2.ProofreadingResult')
