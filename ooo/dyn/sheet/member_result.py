...
if (not TYPE_CHECKING) and UNO_RUNTIME and UNO_ENVIRONMENT:
    ...
    def _get_class():
        orig_init = None
        def init(self, Name = UNO_NONE, Caption = UNO_NONE, Flags = UNO_NONE, Value = UNO_NONE):
            ...
            if not Caption is UNO_NONE:
                if getattr(self, 'Caption') != Caption:
                    setattr(self, 'Caption', Caption)
